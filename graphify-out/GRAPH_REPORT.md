# Graph Report - ObsidianVault  (2026-07-23)

## Corpus Check
- 9236 files · ~16,769,180 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 50137 nodes · 97449 edges · 3900 communities (2507 shown, 1393 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 4507 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `46f41352`
...
## Communities (3900 total, 1393 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (235): BaseStrategy, BenchmarkEngine, BenchmarkEngine, Execute a batch of tasks., Main engine for running swarm benchmarks., Initialize the benchmark engine., Submit a task to the benchmark queue., Agent (+227 more)
...
Cohesion: 0.03
Nodes (80): createCallExtractor(), createClassExtractor(), extractScopeSegmentsFromNode(), normalizeQualifiedName(), splitQualifiedName(), extractFieldType(), extractCSharpParameters(), extractParametersFromList() (+72 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (46): createCoderAgent(), createAgentFactory(), createResearcherAgent(), DeliveryManager, MessageRouter, createTestRequest(), createTestResponse(), sleep() (+38 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (94): formatHealthStatus(), formatLogLevel(), formatStatus(), getAgentCapabilities(), updateSwarmActivityMetrics(), getClaimsConfigPaths(), loadClaimsConfig(), saveClaimsConfig() (+86 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (117): handleMessage(), ensureAgentDir(), getAgentDir(), getAgentPath(), loadAgentStore(), saveAgentStore(), sanitizeError(), validatePositiveInt() (+109 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (119): ABC, AdaptiveStrategy, AggressiveStrategy, ConfidenceLevel, DecisionContext, DecisionCriteria, DecisionOption, DecisionResult (+111 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (101): BenchmarkConfig, BenchmarkResult, HiveMindBenchmarkRunner, main(), Execute a hive-mind CLI command and measure performance, Measure current system performance metrics, Run a single benchmark configuration, Configuration for Hive Mind benchmarks (+93 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (110): AgenticHookManager, createHookContext(), getHookSystemStatus(), initializeAgenticFlowHooks(), setupDefaultPipelines(), shutdownAgenticFlowHooks(), startMetricsCollection(), adjustRequestForRetry() (+102 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (73): createClaudeSlashCommands(), copyAgentFiles(), copyCommandFiles(), createAgentDirectories(), validateAgentSystem(), batchInitCommand(), batchInitFromConfig(), BatchProgressTracker (+65 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (21): createAnalystAgent(), createArchitectAgent(), createCoordinatorAgent(), createTesterAgent(), EventBus, generateSecureEventId(), TypedEventBus, generateTestTasks() (+13 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (139): extractCVarType(), extractGoVarType(), extractTypeFromPython(), detectCppConstructorType(), extractCppElementTypeFromTypeNode(), extractCppTemplateTypeArgs(), extractDeclaration(), extractFirstTemplateTypeArg() (+131 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (92): createASTCache(), BindingAccumulator, enrichExportedTypeMap(), buildExportedTypeMapFromGraph(), buildReceiverTypeIndex(), collectExportedBindings(), countCallableCandidates(), dedupSwiftExtensionCandidates() (+84 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (20): createConnectionPool(), ManagedConnection, quickStart(), createMCPServer(), createSessionManager(), SessionManager, createToolRegistry(), defineTool() (+12 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (71): expandCopies(), extractDisp(), extractDsn(), extractParam(), extractPgm(), extractProc(), parseJcl(), integrateJclResults() (+63 more)
...
Cohesion: 0.03
Nodes (52): applyPreset(), handleReset(), handleSave(), CommunicationLog(), DependencyGraph(), PlanVisualization(), QualityGates(), RealTimeEventLog() (+44 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (19): getAnalyticsManager(), getAuditManager(), getCloudManager(), getDeploymentManager(), getProjectManager(), getSecurityManager(), ConfigManager, deepClone() (+11 more)
...
Cohesion: 0.04
Nodes (35): NativeAdapter, VSCodeAdapter, VSCodeTerminalWrapper, testCoordinationFeatures(), TerminalManager, TerminalPool, TerminalSession, cleanupTestEnv() (+27 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (85): callRuvSwarmDirectNeural(), callRuvSwarmMCP(), checkRuvSwarmAvailable(), chunk(), clearLine(), ensureDirectory(), execRuvSwarmHook(), exit() (+77 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (72): Main benchmark engine for orchestrating swarm tests., Core benchmarking framework components., Core data models for the swarm benchmarking tool., Optimized benchmark engine with performance improvements., Orchestration manager for coordinating parallel benchmark execution., _execute_task_in_process(), Parallel execution system for concurrent benchmark runs with resource management, Execute task in a separate process (pickleable function). (+64 more)

### Community 26 - "Community 26"
Cohesion: 0.05
Nodes (79): CLI, error(), info(), main(), success(), warning(), configIntegrationAction(), handleExport() (+71 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (75): CompletionGenerator, formatDuration(), formatProgressBar(), formatStatusIndicator(), handleError(), setupLogging(), setupSignalHandlers(), CommandCompleter (+67 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (84): MCPBridge, MCPToolCLI, _parse_simple_args(), MCP Bridge for GitNexus  Starts the GitNexus MCP server as a subprocess and prov, Call a GitNexus MCP tool and return the result.                  Returns the too, List available MCP tools., Read an MCP resource by URI., Find the gitnexus CLI binary. (+76 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (29): getDefaultCollectionManager(), setDefaultCollectionManager(), validatePlugin(), validatePluginMetadata(), getAllOfficialPlugins(), getOfficialCollection(), DefaultEventBus, getDefaultEnhancedRegistry() (+21 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (10): MockAgentManager, MockConfigManager, MockMcpServer, MockMemoryManager, MockOrchestrator, MockRealTimeMonitor, MockSwarmCoordinator, MockTaskEngine (+2 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (60): resolveDisplayInfo(), InlineWikilinkChipView(), getTypeIcon(), QuickOpenPalette(), SearchPanel(), resolveSectionColors(), toResult(), useNoteSearch() (+52 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (71): classification_metrics(), clustering_metrics(), CrossValidator, EvalConfig, MetricsCalculator, ModelComparator, ModelEvaluator, Model evaluation framework for MLE-STAR. (+63 more)

### Community 33 - "Community 33"
Cohesion: 0.03
Nodes (19): createInProcessServer(), InProcessMCPServer, getInProcessMCPStatus(), initializeInProcessMCP(), MCPIntegrationFactory, createInProcessQuery(), getInProcessServerConfig(), getSDKIntegration() (+11 more)

### Community 34 - "Community 34"
Cohesion: 0.03
Nodes (56): isVisibleRect(), isWithinBlockNoteHandleHoverBridge(), shouldSuppressBlockNoteHandleHoverUpdate(), useBlockNoteSideMenuHoverGuard(), classifyDiffLine(), DiffLine(), DiffView(), buildInlineWikilinkSuggestions() (+48 more)
...
Cohesion: 0.04
Nodes (25): createCompiler(), createGates(), EnforcementGates, createToolGateway(), createComplianceSuite(), createHeadlessRunner(), createGuidanceHooks(), gateResultsToHookResult() (+17 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (13): PolicyEngine, TrustEvaluator, FederationNode, FederationSession, getTrustLevelLabel(), isOperationAllowed(), HandshakeService, RoutingService (+5 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (65): auto_make_url(), BaseSession, ClaudeSession, compress_history_tags(), _fix_messages(), __getattr__(), LLMSession, _load_mykeys() (+57 more)
...
Cohesion: 0.03
Nodes (59): AggregatedMetric, MetricAggregator, MetricAnalyzer, MetricCollector, MetricDefinition, MetricPoint, MetricType, Metric Aggregator  Real-time metric collection and aggregation system for Claude (+51 more)

### Community 41 - "Community 41"
Cohesion: 0.04
Nodes (30): A2CAlgorithm, CuriosityModule, DecisionTransformer, DQNAlgorithm, PPOAlgorithm, QLearning, SARSAAlgorithm, applyLoRATransform() (+22 more)

### Community 42 - "Community 42"
Cohesion: 0.04
Nodes (74): batch_config(), batch_processor(), MockBatchConfig, MockBatchProcessor, MockBenchmarkTask, MockPipeline, MockPipelineManager, MockPipelineStage (+66 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (16): InMemoryDeviceRepository, InMemoryFleetRepository, InMemoryTrustHistoryRepository, SeedClientFactory, createMcpTools(), textResult(), createMockCoordinator(), makeCoordinator() (+8 more)

### Community 44 - "Community 44"
Cohesion: 0.04
Nodes (39): Arena, ArenaManager, scopedArena(), withArena(), withArenaSync(), acquireBead(), acquireConvoy(), acquireFormula() (+31 more)

### Community 45 - "Community 45"
Cohesion: 0.03
Nodes (57): BottleneckDetector, BottleneckIdentification, OptimizationEngine, OptimizationOpportunity, PerformanceAnalysis, PerformanceAnalyzer, PerformanceCategory, PerformanceMetric (+49 more)

### Community 46 - "Community 46"
Cohesion: 0.04
Nodes (15): MCPAsyncJobManager, MemoryJobPersistence, executor(), executor(), createMCPServer(), getServerCapabilities(), isMCP2025Available(), MCPServerFactory (+7 more)
...
Cohesion: 0.03
Nodes (54): BenchmarkResult, MLE-STAR Ensemble Executor  Coordinates multiple ML models in an ensemble, imple, Result of ensemble benchmark execution., MLE-STAR Ensemble Integration Module  This module provides ensemble learning cap, BenchmarkHistory, Performance Tracker for MLE-STAR Ensemble  Tracks and analyzes performance metri, Historical benchmark results., BayesianAveraging (+46 more)
...
Cohesion: 0.04
Nodes (74): useMultiSelect(), resolvePropertyChipLabels(), buildFilterPropertyPicker(), buildTypePropertyPicker(), buildViewPropertyPicker(), canPersistTypeSort(), canPrefetchEntryContent(), collectAvailableProperties() (+66 more)
...
Cohesion: 0.03
Nodes (58): Run a comprehensive demonstration of all features., run_comprehensive_demo(), Run a benchmark and display the improved report., run_benchmark_with_report(), main(), Run focused hive-mind benchmarks., Run focused SPARC benchmarks., Run comprehensive real benchmark suite. (+50 more)

### Community 55 - "Community 55"
Cohesion: 0.03
Nodes (53): AsyncPerformanceCollector, PerformanceCollector, Collect metrics for tracked processes., Collect system-wide metrics., Aggregate collected metrics into final performance metrics., Get detailed metrics for analysis., Save raw metrics data for later analysis., Async version of the performance collector. (+45 more)
...
Cohesion: 0.05
Nodes (67): consensus_swarm(), hive_benchmark(), knowledge_swarm(), MockHiveMindBenchmark, MockSwarm, MockSwarmAgent, Unit tests for collective intelligence benchmarking.  Tests the hive mind benchm, Mock swarm for testing collective intelligence. (+59 more)

### Community 59 - "Community 59"
Cohesion: 0.03
Nodes (14): CrossModalAttention, FlamingoAttention, GraphAttention, HyperbolicAttention, KNNAttention, MixtureOfExpertsAttention, PerceiverAttention, RecurrentAttention (+6 more)

### Community 60 - "Community 60"
Cohesion: 0.03
Nodes (70): Extract metrics from command output., fold_turns(), init(), Return list of segments: [{'type':'text','content':...}, {'type':'fold','title':, render_sidebar(), _reset_and_rerun(), _clean(), cmd_llm() (+62 more)
...
Cohesion: 0.03
Nodes (59): create_cross_topic_links(), create_file_index(), create_master_topics_index(), create_moc_file(), extract_topics_from_file(), get_all_files(), organize_by_topics(), Extract topics from file content and name (+51 more)
...
Cohesion: 0.04
Nodes (39): readSafe(), buildProtoContext(), buildProtoMap(), contractId(), extractServiceBlocks(), GrpcExtractor, makeContract(), normalizeProtoPath() (+31 more)

### Community 71 - "Community 71"
Cohesion: 0.06
Nodes (15): ClaudeAPIError, ClaudeAuthenticationError, ClaudeInternalServerError, ClaudeNetworkError, ClaudeRateLimitError, ClaudeServiceUnavailableError, ClaudeTimeoutError, ClaudeValidationError (+7 more)
...
Cohesion: 0.03
Nodes (38): RenameDetectedBanner(), SettingsPanel(), Toast(), MockWebSocket, useAiActivity(), useAiAgentsOnboarding(), useConflictResolver(), useDialogs() (+30 more)
...
Cohesion: 0.05
Nodes (29): createConnectionPool(), ManagedConnection, createPromptRegistry(), definePrompt(), interpolate(), resourceMessage(), textMessage(), createRateLimiter() (+21 more)

### Community 78 - "Community 78"
Cohesion: 0.03
Nodes (39): OnboardingShell(), formatDateKey(), formatDayLabel(), groupCommitsByDay(), isToday(), isYesterday(), tauriCall(), isSelectionActive() (+31 more)
...
Cohesion: 0.05
Nodes (57): MLEStarConfig, MLEStarEnsembleExecutor, Initialize all models in parallel using swarm agents., Spawn a specialized ML agent for a model., Configuration for MLE-STAR ensemble., Gather predictions from all models in parallel., Build consensus from multiple model predictions.                  Returns:, Analyze ensemble performance and return comprehensive metrics. (+49 more)

### Community 81 - "Community 81"
Cohesion: 0.04
Nodes (9): createEconomyBridge(), FinancialEconomyBridge, PortfolioRiskCalculator, AnomalyDetector, createSparseBridge(), FinancialSparseBridge, MarketRegimeClassifier, createFinancialPlugin() (+1 more)

### Community 82 - "Community 82"
Cohesion: 0.06
Nodes (31): advancedMemoryCommand(), cleanupCommand(), configCommand(), deleteCommand(), ensureMemoryManager(), exportCommand(), formatBytes(), formatDuration() (+23 more)
...
Cohesion: 0.04
Nodes (48): duration(), efficiency_score(), is_expired(), LoadBalancer, ResourcePool for managing computational resources across parallel executions.  T, Check if resource can accommodate the specification., Allocate resources according to specification., Deallocate resources from an allocation. (+40 more)

### Community 91 - "Community 91"
Cohesion: 0.04
Nodes (45): CognitivePattern, MemoryEfficiencyTester, NeuralBenchmarkMetrics, NeuralBenchmarkResult, NeuralProcessingBenchmark, NeuralTestScenario, ParallelNeuralProcessor, PatternProcessor (+37 more)
...
Cohesion: 0.04
Nodes (49): multi_mode(), official(), optimize(), SWE-Bench CLI command integration., Run OFFICIAL SWE-bench evaluation with real dataset.          This command uses, Run SWE-Bench software engineering benchmarks., Test ALL claude-flow non-interactive modes on SWE-bench.          This command b, Run automated optimization to achieve target metrics. (+41 more)

### Community 94 - "Community 94"
Cohesion: 0.04
Nodes (15): CollusionDetector, createCollusionDetector(), createMemoryQuorum(), createThreatDetector(), MemoryQuorum, ThreatDetector, computeValueHash(), createMemoryEntry() (+7 more)

### Community 95 - "Community 95"
Cohesion: 0.04
Nodes (54): getConnectErrorMessage(), shouldCloseAfterResult(), submitRemoteConnection(), tauriCall(), tauriCall(), tauriCall(), useClaudeCodeStatus(), checkpointToastMessage() (+46 more)

### Community 96 - "Community 96"
Cohesion: 0.05
Nodes (52): leak_detector(), mock_component(), MockPerformanceComponent, perf_harness(), perf_harness_with_baselines(), PerformanceTestHarness, Performance regression test suite.  Tests performance characteristics, identifie, Set baseline performance metrics for a test. (+44 more)
...
Cohesion: 0.06
Nodes (74): extract_h1_title(), extract_title(), slug_to_title(), assert_move_note_to_folder_error(), assert_rename_note_filename_error(), assert_slug_case(), assert_unicode_rename_filesystem(), assert_unicode_rename_frontmatter() (+66 more)
...
Cohesion: 0.04
Nodes (46): getDeterministicShortcutQaDefinition(), dispatchActiveTabCommand(), dispatchAppCommand(), dispatchDefinition(), dispatchMultiSelectionCommand(), executeAppCommand(), isShortcutEchoPair(), now() (+38 more)
...
Cohesion: 0.07
Nodes (65): get_vault_ai_guidance_status(), guidance_commands_report_and_restore_vault_guidance_files(), restore_vault_ai_guidance(), AiGuidanceFileState, assert_legacy_agents_move_to_root(), assert_preserves_custom_agents(), assert_refreshes_outdated_managed_agents(), assert_stub_agents_are_replaced() (+57 more)
...
Cohesion: 0.04
Nodes (40): Check individual resource health., enforce_rate_limit(), get_remaining_slots(), Canonical implementation in the backend root., Another function in middleware., Estimate time remaining based on average task time., Main monitoring loop., Update scheduling metrics. (+32 more)

### Community 112 - "Community 112"
Cohesion: 0.05
Nodes (20): computeQuantizationStats(), createQuantizer(), createRng(), deserializeQuantizer(), dot(), estimateRecall(), euclideanDistance(), identityMatrix() (+12 more)

### Community 113 - "Community 113"
Cohesion: 0.03
Nodes (26): handleKeyDown(), handleSelectCommand(), handleSubmitAiPrompt(), inputSelectionRange(), insertNativePathDrop(), matchCommand(), rememberCommandOpener(), setSelection() (+18 more)
...
Cohesion: 0.04
Nodes (36): ObjectiveAnalyzer, Analyze objectives and generate execution strategies., Analyze the objective and determine its characteristics.                  Args:, Classify the objective type., Assess objective complexity., Estimate execution duration in seconds., Identify required capabilities., Estimate resource requirements. (+28 more)

### Community 119 - "Community 119"
Cohesion: 0.06
Nodes (22): clamp(), CoherenceScheduler, createCoherenceScheduler(), createEconomicGovernor(), EconomicGovernor, safePercentage(), ConformanceRunner, createConformanceRunner() (+14 more)

### Community 120 - "Community 120"
Cohesion: 0.09
Nodes (16): add(), ASTEmbedder, clamp(), createHyperbolicSpace(), dot(), fromEmbeddingConfig(), HierarchyEmbedder, HyperbolicSpace (+8 more)
...
Cohesion: 0.05
Nodes (13): GtBridge, GtBridgeError, hashArgs(), createFormulaExecutor(), hashKey(), JsFallbackWasmLoader, WorkStealingQueue, AsyncLazy (+5 more)
...
Cohesion: 0.04
Nodes (35): Generate global optimization recommendations., Optimize configuration based on historical performance data.                  Ar, Suggest dynamic adjustments based on current performance.                  Args:, Analyze performance patterns across different configurations.                  R, Predict performance for a given configuration and task mix.                  Arg, Automatically tune configuration to meet target metrics.                  Args:, Export comprehensive optimization report.                  Args:             out, Create a deep copy of a configuration. (+27 more)

### Community 128 - "Community 128"
Cohesion: 0.05
Nodes (13): main(), SwarmLoadTester, createTaskCancelCommand(), createTaskCreateCommand(), createTaskListCommand(), createTaskStatusCommand(), createTaskWorkflowCommand(), TaskEngine (+5 more)
...
Cohesion: 0.04
Nodes (8): applyOverrides(), get(), set(), closeCommandPalette(), executeCommand(), findCommand(), openCommandPalette(), verifyVisible()
...
Cohesion: 0.05
Nodes (5): AtomicOperation, createAtomicOperation(), RollbackSystem, RollbackExecutor, StateTracker
...
Cohesion: 0.05
Nodes (11): BidirectionalAttention, ChunkAttention, DilatedAttention, FlashAttention, FlashAttentionV2, formatMatrix(), getScale(), GlobalAttention (+3 more)
...
Cohesion: 0.06
Nodes (35): BaseHandler, StepOutcome, GeneraticAgent, get_system_prompt(), load_tool_schema(), ask_user(), code_run(), consume_file() (+27 more)

### Community 142 - "Community 142"
Cohesion: 0.08
Nodes (48): findEnclosingFunction(), detectFrameworkFromAST(), preprocessImportPath(), cachedFindEnclosingClassInfo(), countNewlines(), extractTemplateComponents(), extractVueScript(), isVueSetupTopLevel() (+40 more)

### Community 143 - "Community 143"
Cohesion: 0.07
Nodes (49): integrated_system(), MockIntegratedSystem, MockPipelineWorkflow, monitored_workflow(), pipeline_workflow(), Integration tests for complete pipeline workflows.  Tests end-to-end scenarios c, Stage 1: CLAUDE.md configuration optimization., Stage 2: MLE-STAR ensemble setup and execution. (+41 more)

### Community 144 - "Community 144"
Cohesion: 0.05
Nodes (41): description(), name(), Analysis strategy for data analysis and insights., description(), name(), Auto strategy that automatically selects the best approach., description(), execute() (+33 more)
...
Cohesion: 0.05
Nodes (34): augment(), findRepoForCwd(), augmentCommand(), batchInsertNodesToLbug(), createFTSIndex(), deleteNodesForFile(), doInitLbug(), ensureFTSIndex() (+26 more)

### Community 151 - "Community 151"
Cohesion: 0.09
Nodes (40): checkAvailability(), fetchFromIPFS(), fetchFromIPFSWithMetadata(), formatBytes(), getGatewayUrl(), getGatewayUrls(), hashContent(), isPinned() (+32 more)
...
Cohesion: 0.06
Nodes (60): AgentStreamRequest, build_chat_args(), build_chat_args_basic(), build_chat_args_empty_system_prompt_is_skipped(), build_chat_args_with_session_id(), build_chat_args_with_system_prompt(), ChatStreamRequest, claude_binary_candidates() (+52 more)

### Community 156 - "Community 156"
Cohesion: 0.06
Nodes (18): listCommand(), contextCommand(), cypherCommand(), detectChangesCommand(), formatDetectChangesResult(), getBackend(), impactCommand(), output() (+10 more)

### Community 157 - "Community 157"
Cohesion: 0.04
Nodes (32): ModelPerformance, PerformanceTracker, Calculate success rate., Calculate average confidence score., Track and analyze performance metrics for MLE-STAR ensembles.          Provides, Start a new tracking session., End the current tracking session., Monitor system resources continuously. (+24 more)
...
Cohesion: 0.08
Nodes (11): TieredCacheManager, createMockBackend(), mockEmbedding(), safeJsonParse(), MemoryGraph, createMockBackend(), makeEntry(), createMigrator() (+3 more)

### Community 162 - "Community 162"
Cohesion: 0.05
Nodes (38): addCondition(), addGroup(), normalizeRegexFlag(), removeChild(), setGroupChildren(), supportsRegex(), toggleMode(), updateChild() (+30 more)

### Community 163 - "Community 163"
Cohesion: 0.06
Nodes (40): buildAiAgentCommands(), explicitSwitchCommands(), restoreGuidanceCommands(), getPromptCopy(), useAiAgentPreferences(), tauriCall(), useAiAgentsStatus(), tauriCall() (+32 more)
...
Cohesion: 0.09
Nodes (49): BdBridgeError, createBdBridge(), hashArgs(), createGtBridge(), createSyncBridge(), hashKey(), SyncBridgeError, createGasTownBridgePlugin() (+41 more)
...
Cohesion: 0.06
Nodes (11): AttentionBridge, createAttentionBridge(), cosineSimilarity(), createNervousSystemBridge(), NervousSystemBridge, collectiveMemoryHandler(), emergentProtocolHandler(), neuralConsensusHandler() (+3 more)

### Community 173 - "Community 173"
Cohesion: 0.07
Nodes (16): createByzantineConsensus(), BoundedSet, createGossipConsensus(), ConsensusEngine, createConsensusEngine(), selectOptimalAlgorithm(), createRaftConsensus(), createAgentPool() (+8 more)
...
Cohesion: 0.07
Nodes (45): apply_window_frame(), best_screen_for_frame(), cache_current_normal_frame(), cache_frame(), cached_frame(), clamp_axis(), clamp_dimension(), clamps_oversized_frame_to_current_work_area() (+37 more)

### Community 184 - "Community 184"
Cohesion: 0.08
Nodes (40): Command, cwd(), execPath(), exit(), getDirname(), getFilename(), getImportMetaUrl(), isMainModule() (+32 more)
...
Cohesion: 0.05
Nodes (8): CognitiveBridge, createCognitiveBridge(), cosineSimilarity(), createSonaBridge(), SonaBridge, getMCPTools(), getPluginState(), shutdownPlugin()
...
Cohesion: 0.05
Nodes (16): Caller, GET(), POST(), GET(), POST(), handleServerError(), getClientAddressSafe(), handleRequest() (+8 more)
...
Cohesion: 0.09
Nodes (45): cacheNoteContent(), clearPrefetchCache(), clearTabs(), dropOldestPrefetchEntry(), getCachedNoteContent(), getEntryLoadFailureKind(), getRetainedPrefetchCacheBytes(), handleEntryLoadFailure() (+37 more)

### Community 196 - "Community 196"
Cohesion: 0.06
Nodes (13): copyDirSync(), createFixtureVaultCopy(), installFixtureVaultInitScript(), openFixtureVault(), removeFixtureVaultCopy(), removeFixtureVaultDirectory(), waitForFixtureVaultReady(), installFixtureVaultDesktopBridgeInBrowser() (+5 more)
...
Cohesion: 0.1
Nodes (28): createDiscoveryService(), createDownloader(), createPatternStore(), checkContributionStatus(), createPublisher(), PatternPublisher, quickPublish(), submitContribution() (+20 more)
...
Cohesion: 0.08
Nodes (3): DefaultLogger, EnhancedPluginRegistry, EnhancedServiceContainer

### Community 204 - "Community 204"
Cohesion: 0.08
Nodes (26): createConvoyObserver(), createLazyConvoyObserver(), getLazyObserverStats(), createConvoyTracker(), BeadsError, CLIExecutionError, ConvoyError, FormulaError (+18 more)
...
Cohesion: 0.07
Nodes (38): batch_delete_notes_async(), batch_delete_notes_async_validates_and_deletes_inside_vault(), build_vault_root_paths(), canonicalize_candidate_for_write(), find_existing_ancestor(), load_configured_active_vault_root(), path_to_string(), validate_relative_child_path() (+30 more)
...
Cohesion: 0.07
Nodes (34): buildFilterCommands(), buildGitCommands(), localizeCommandActions(), localizeCommandGroup(), localizeSettingsStateCommand(), localizeTypeCommand(), parenthesizedSuffix(), stripKnownPrefix() (+26 more)

### Community 216 - "Community 216"
Cohesion: 0.07
Nodes (43): evaluate_bool_field(), evaluate_condition(), evaluate_group(), evaluate_node(), evaluate_relationship_op(), evaluate_view(), FilterCondition, FilterGroup (+35 more)

### Community 217 - "Community 217"
Cohesion: 0.09
Nodes (46): register_mcp_tools(), build_mcp_entry(), build_mcp_entry_produces_correct_json(), check_mcp_status(), check_mcp_status_returns_installed_for_matching_vault(), entry_index_js_exists(), entry_targets_vault(), fallback_node_path() (+38 more)
...
Cohesion: 0.08
Nodes (10): cosineSimilarity(), generateId(), PersistentSonaCoordinator, ensureDirectory(), RvfLearningStore, makeEwc(), makeLora(), makePattern() (+2 more)
...
Cohesion: 0.08
Nodes (41): clone_git_repo(), clone_repo(), git_add_remote(), GitAddRemoteRequest, create_initialized_vault(), desktop_git_commands_route_to_git_backend(), desktop_remote_commands_report_no_remote(), get_conflict_files() (+33 more)
...
Cohesion: 0.07
Nodes (14): clearCache(), constructor(), detectTaskType(), estimateComplexity(), getCacheKey(), getMetrics(), initializeMetrics(), initializeTaskPatterns() (+6 more)

### Community 226 - "Community 226"
Cohesion: 0.08
Nodes (6): AdvancedRateLimiter, AgentAuthenticationSystem, CryptographicCore, SecurityEnforcementSystem, ThresholdSignatureSystem, ZeroKnowledgeProofSystem

### Community 227 - "Community 227"
Cohesion: 0.09
Nodes (47): extractEditorBody(), isUntitledPath(), normalizeParsedImageBlocks(), pathStem(), applyBlankStateToEditor(), applyBlankTabState(), applyBlocksToEditor(), blankParagraphBlocks() (+39 more)
...
Cohesion: 0.09
Nodes (27): createGnnBridge(), createMinCutBridge(), CodeIntelligencePlugin, createPlugin(), analyzeAPISurface(), buildSuggestedModules(), calculateCohesionMetrics(), calculateCouplingMetrics() (+19 more)

### Community 236 - "Community 236"
Cohesion: 0.1
Nodes (19): createExoticBridge(), createHyperbolicBridge(), createTestSonaBridge(), initializePlugin(), validateConfig(), embedHierarchyHandler(), entailmentGraphHandler(), getGnnBridge() (+11 more)

### Community 237 - "Community 237"
Cohesion: 0.08
Nodes (24): createDagBridge(), LegalContractsPlugin, assessRisks(), buildCategorySummary(), buildNegotiationPriorities(), buildTimeline(), calculateOverallRiskScore(), calculateTextSimilarity() (+16 more)

### Community 239 - "Community 239"
Cohesion: 0.11
Nodes (20): compilePatterns(), runCompiledPatterns(), scanFile(), unquoteLiteral(), getPluginForFile(), compileBundle(), findFirstTypeAnnotationText(), resolveGrpcClientFieldType() (+12 more)
...
Cohesion: 0.09
Nodes (17): createFieldRegistry(), makeDef(), createMethodRegistry(), createRegistrationTable(), makeDeps(), createResolutionContext(), isFileInPackageDir(), createSemanticModel() (+9 more)
...
Cohesion: 0.09
Nodes (26): addCollaborator(), addError(), assignTask(), collectMetrics(), constructor(), createDefaultMetrics(), getAgentInfo(), getAgentStatus() (+18 more)
...
Cohesion: 0.06
Nodes (4): IoTCoordinator, makeDevice(), makeMockCoordinator(), HealthProbeWorker

### Community 262 - "Community 262"
Cohesion: 0.07
Nodes (13): AttentionRegistry, CausalAttention, configure(), constructor(), CrossAttention, formatVector(), getConfig(), MultiHeadAttention (+5 more)

### Community 263 - "Community 263"
Cohesion: 0.07
Nodes (7): BalancedMode, BalancedMode, BatchMode, EdgeMode, BaseModeImplementation, RealTimeMode, ResearchMode
...
Cohesion: 0.09
Nodes (34): agents_content_can_be_replaced(), agents_content_can_be_refreshed(), AgentsContent, AgentsContent<'a>, assert_getting_started_vault_replaces_template(), canonical_getting_started_vault_exists(), canonical_vault_path(), create_getting_started_vault() (+26 more)

### Community 266 - "Community 266"
Cohesion: 0.11
Nodes (32): ManifestExtractor, manifestSymbolUid(), normalizeRoutePath(), parseHttpContract(), bridgeExists(), closeBridgeDb(), contractNodeId(), createContractLookupIndex() (+24 more)
...
Cohesion: 0.07
Nodes (30): findOrCreateType(), findTypeEntry(), useEntryActions(), useFeatureFlag(), resolveReleaseChannel(), syncAnalytics(), syncCrashReporting(), tauriCall() (+22 more)
...
Cohesion: 0.07
Nodes (26): populateTestData(), array(), assert_complex_frontmatter_case(), complex_frontmatter_cases(), FrontmatterCase, test_complex_frontmatter_preserves_type_and_organized(), test_fallback_parser_extracts_type_and_organized(), extract_fm_and_rels() (+18 more)

### Community 281 - "Community 281"
Cohesion: 0.09
Nodes (31): CoordinationMode, ExecutionResult, ExecutionStrategy, OutputFormat, Claude-Flow Executor - Integration layer for executing claude-flow commands.  Th, Configuration for swarm execution., Configuration for SPARC execution., Swarm execution strategies. (+23 more)
...
Cohesion: 0.13
Nodes (10): createA2C(), createDecisionTransformer(), createDQN(), createAlgorithm(), getDefaultConfig(), createPPO(), createQLearning(), QLearning (+2 more)
...
Cohesion: 0.08
Nodes (38): assert_note_write_rejects_escape(), assert_paths_absent(), assert_paths_exist(), assert_save_view_cmd_rejects_invalid_filename(), assert_seeded_guidance_content(), assert_seeded_type_scaffolding(), sample_view_definition(), temp_note() (+30 more)
...
Cohesion: 0.08
Nodes (10): createLazyProperty(), disposeAllLazySingletons(), disposeLazySingleton(), getLazySingleton(), getOrCreateLazy(), Lazy, LazyBridge, LazyModule (+2 more)
...
Cohesion: 0.08
Nodes (22): performance_monitoring(), PerformanceMetrics, PerformanceSnapshot, Create benchmarks designed for performance analysis., Execute benchmark with comprehensive performance monitoring., Single performance measurement snapshot., Build command for performance benchmark., Create comprehensive performance metrics from monitoring data. (+14 more)
...
Cohesion: 0.1
Nodes (16): deleteFromGCS(), downloadFromGCS(), existsInGCS(), generateContentId(), getGCSConfig(), getGCSStatus(), hasGCSCredentials(), isGCloudAuthenticated() (+8 more)
...
Cohesion: 0.06
Nodes (10): installFixtureVaultDesktopBridge(), openFixtureVaultDesktopHarness(), openAlphaProjectInEditor(), dispatchCommandShortcut(), focusNoteList(), selectVisibleInboxBatch(), buildViewEntry(), injectViewEntryIntoVaultList() (+2 more)

### Community 323 - "Community 323"
Cohesion: 0.09
Nodes (29): delete_frontmatter_property(), test_delete_frontmatter_block_scalar(), test_roundtrip_add_then_delete(), test_roundtrip_block_scalar(), test_roundtrip_update_list(), test_roundtrip_update_string(), test_update_frontmatter_block_scalar_writes_and_rewrites(), test_update_frontmatter_empty_block() (+21 more)
...
Cohesion: 0.11
Nodes (34): setup_remote_pair(), classify_push_error(), contains_any(), current_branch(), git_pull(), git_push(), git_remote_status(), GitPullResult (+26 more)

### Community 329 - "Community 329"
Cohesion: 0.09
Nodes (31): test_parse_malformed_yaml(), test_parse_md_file_has_snippet(), test_parse_md_file_has_word_count(), test_parse_md_file_word_count_empty_body(), test_parse_no_frontmatter(), test_parse_single_string_aliases(), test_reload_entry_nonexistent_file(), test_reload_entry_returns_fresh_data() (+23 more)

### Community 330 - "Community 330"
Cohesion: 0.09
Nodes (21): ClaudeFlowRealExecutor, Real executor for Claude Flow commands with comprehensive metrics., Execute real swarm with ./claude-flow and measure performance., Execute real hive-mind with ./claude-flow.                  Args:             ta, Execute real SPARC mode with ./claude-flow.                  Args:             m, Extract token usage from Claude Flow output., Extract agent count from Claude Flow output., Count error occurrences in text. (+13 more)
...
Cohesion: 0.11
Nodes (6): createEventStore(), createPersistentLedger(), EventStore, PersistentLedger, createMockEvent(), tick()
...
Cohesion: 0.09
Nodes (8): main(), printHelp(), GuidanceProvider, FallbackEmbeddingService, onPostTask(), onSessionEnd(), onSessionStart(), RealEmbeddingService

### Community 351 - "Community 351"
Cohesion: 0.09
Nodes (3): DefaultLogger, DefaultServiceContainer, PluginRegistry
...
Cohesion: 0.08
Nodes (20): Convert config to command line arguments., Parser for streaming JSON output from Claude Flow., Parse a single line of streaming JSON output., Parse a structured message., Parse plain text line for patterns., Executor for real Claude Flow commands., Initialize the real executor.                  Args:             claude_flow_pat, Find the ./claude-flow executable. (+12 more)

### Community 358 - "Community 358"
Cohesion: 0.1
Nodes (29): ensureAndParse(), findDeclarationNode(), findFunctionNode(), extractFieldNames(), extractMethodNames(), extractStructuralNames(), buildTypeEnv(), createClassDefCache() (+21 more)
...
Cohesion: 0.13
Nodes (23): formatTimeAgo(), formatTimeUntil(), getBackgroundDaemonPid(), isProcessRunning(), killBackgroundDaemon(), killStaleDaemons(), startBackgroundDaemon(), validatePath() (+15 more)
...
Cohesion: 0.11
Nodes (12): generateVector(), runHNSWIndexingBenchmarks(), BatchedMemoryStore, generateTestData(), generateVector(), runMemoryWriteBenchmarks(), SimpleMemoryStore, VectorStore (+4 more)

### Community 370 - "Community 370"
Cohesion: 0.11
Nodes (11): main(), verify(), createDatabase(), detectPlatform(), getAvailableProviders(), getPlatformInfo(), JsonBackend, selectProvider() (+3 more)
...
Cohesion: 0.09
Nodes (5): ConnectionPool, createConnectionPool(), createPooledHttpTransport(), HttpConnectionFactory, PooledHttpTransport
...
Cohesion: 0.1
Nodes (24): LinuxTitlebar(), useLinuxMaximizedState(), findShortcutCommandId(), findShortcutCommandIdForEvent(), getShortcutEventInit(), isAppCommandId(), isNativeMenuCommandId(), normalizeShortcutKey() (+16 more)
...
Cohesion: 0.08
Nodes (20): ComparativeAnalysisEngine, ComparisonConfig, ComparisonResult, Build command specific to methodology., Parse output for comparison metrics., Calculate quality score based on output analysis., Configuration for comparative analysis., Estimate token consumption from output. (+12 more)
...
Cohesion: 0.09
Nodes (8): AuthorityGate, createAuthorityGate(), createIrreversibilityClassifier(), getAuthorityHierarchy(), getNextHigherAuthority(), IrreversibilityClassifier, isHigherAuthority(), timingSafeEqual()
...
Cohesion: 0.08
Nodes (7): createFailingMockMCPClient(), createSlowMockMCPClient(), createStandardMockMCPClient(), MCPClientError, MockMCPClient, MockMCPConnection, MockMCPServer
...
Cohesion: 0.06
Nodes (7): BaseModel, AuthService, Auth service — exercises named imports, aliased imports, function-local imports., emit_all(), Wildcard import — exercises `from X import *`., log_error(), log_info()
...
Cohesion: 0.14
Nodes (9): executeHooks(), HookExecutor, registerHook(), unregisterHook(), addHook(), initializeHooks(), runHook(), cleanupTestDir() (+1 more)
...
Cohesion: 0.11
Nodes (10): createDeepMock(), createMock(), createMockWithBehavior(), createRetryMock(), createSequenceMock(), createSpyMock(), InteractionRecorder, createSwarmTestInstance() (+2 more)

### Community 406 - "Community 406"
Cohesion: 0.11
Nodes (3): FormulaASTCache, LRUCache, ModulePreloader

### Community 407 - "Community 407"
Cohesion: 0.18
Nodes (30): anomalyDetectHandler(), calculateRiskScore(), checkAuthorization(), checkBaselIII(), checkRateLimit(), clinicalPathwaysHandler(), complianceCheckHandler(), drugInteractionsHandler() (+22 more)
...
Cohesion: 0.1
Nodes (21): benchmark_hive_mind_task(), benchmark_sparc_mode(), benchmark_swarm_objective(), Real Benchmark Engine - Uses actual Claude Flow commands for benchmarking.  This, Benchmark engine that uses real Claude Flow execution., Initialize the real benchmark engine.                  Args:             config:, Run a real swarm benchmark.                  Args:             objective: The be, Run a real hive-mind benchmark.                  Args:             task: The tas (+13 more)
...
Cohesion: 0.15
Nodes (10): attentionControlHandler(), calculateAvgPriority(), cognitiveLoadHandler(), metaMonitorHandler(), scaffoldHandler(), workingMemoryHandler(), calculateTotalLoad(), errorResult() (+2 more)
...
Cohesion: 0.11
Nodes (25): EditorContent(), contentHasTopLevelH1(), deriveEditorContentState(), deriveVisibilityState(), findFreshEntry(), getEntryLookup(), resolveHasH1(), deriveState() (+17 more)
...
Cohesion: 0.16
Nodes (10): formatUptime(), getRequestCounts(), resetRequestCounts(), trackRequest(), createMCPServerManager(), getMCPServerStatus(), getServerManager(), MCPServerManager (+2 more)
...
Cohesion: 0.15
Nodes (12): annealingSolveHandler(), dependencyResolveHandler(), getDagBridge(), getExoticBridge(), getTool(), getToolNames(), groverSearchHandler(), qaoaOptimizeHandler() (+4 more)
...
Cohesion: 0.13
Nodes (26): applyMockFrontmatterDelete(), applyMockFrontmatterUpdate(), applyPropertiesPatch(), applyRecordPatch(), applyRelationshipPatch(), contentToEntryPatch(), executeFrontmatterOp(), extractWikilinks() (+18 more)
...
Cohesion: 0.13
Nodes (30): setup_git_repo(), add_file_change(), get_github_base_url(), get_github_commit_url(), get_last_commit_info(), get_vault_pulse(), is_commit_header(), is_git_status_line() (+22 more)
...
Cohesion: 0.19
Nodes (25): createGuppAdapter(), calculateChecksum(), createEmptyState(), createHookedWorkItem(), createSession(), deleteState(), endSession(), getPendingWork() (+17 more)
...
Cohesion: 0.09
Nodes (23): CommandType, execute_hive_mind_spawn(), execute_sparc_mode(), execute_swarm_benchmark(), HiveMindCommand, OutputFormat, Real Claude Flow Executor - Executes actual ./claude-flow commands with subproce, Initialize mutable defaults. (+15 more)
...
Cohesion: 0.12
Nodes (14): loadEditorMode(), isViewMode(), loadViewMode(), useViewMode(), configToPercent(), loadPersistedZoom(), persistZoom(), useZoom() (+6 more)
...
Cohesion: 0.2
Nodes (25): assertOk(), cancelEmbeddings(), connectToServer(), deleteRepo(), fetchClusterDetail(), fetchClusters(), fetchGraph(), fetchProcessDetail() (+17 more)
...
Cohesion: 0.11
Nodes (13): assert_field_lines(), assert_string_yaml_value(), format_yaml_field(), format_yaml_key(), format_yaml_number(), FrontmatterValue, test_format_yaml_field_block_scalar(), test_format_yaml_field_list_layouts() (+5 more)
...
Cohesion: 0.08
Nodes (4): AttentionExecutor, AttentionFactory, AttentionStack, createDefaultRegistry()

### Community 502 - "Community 502"
Cohesion: 0.14
Nodes (7): createSemanticRouter(), compareVersions(), createTeammateBridge(), TeammateError, createTopologyOptimizer(), loadBMSSP(), cleanupTestDir()
...
Cohesion: 0.12
Nodes (3): createOrchestrator(), generateSecureTaskId(), TaskManager
...
Cohesion: 0.1
Nodes (14): apply_title_bar_double_click_action(), check_mcp_status(), exit_status(), MenuStateUpdate, output(), parse_defaults_read_output(), perform_current_window_titlebar_double_click(), propagates_title_bar_action_errors() (+6 more)
...
Cohesion: 0.18
Nodes (20): composeEvidence(), confidenceFromEvidence(), getOriginWeight(), whereFoundEvidenceKind(), applyArityFilter(), collectOwnedMembers(), ensureCandidate(), lookupCore() (+12 more)
...
Cohesion: 0.12
Nodes (3): createWasmBridge(), initializeWasmBridge(), WasmBridge
...
Cohesion: 0.15
Nodes (25): test_create_vault_folder_rejects_escape_path(), test_create_vault_folder_rejects_windows_invalid_names(), commands_reject_paths_outside_requested_vault(), copy_image_to_vault(), create_note_content(), create_vault_folder(), ensure_missing_folder(), folder_and_listing_commands_use_expanded_vault_root() (+17 more)

### Community 576 - "Community 576"
Cohesion: 0.13
Nodes (24): ActiveAssetScopeRoots, apply_linux_appimage_startup_env_overrides(), handle_run_event(), linux_appimage_startup_env_overrides_are_empty_outside_appimage_launches(), linux_appimage_startup_env_overrides_disable_dmabuf_for_appimages(), linux_appimage_startup_env_overrides_preserve_explicit_user_setting(), linux_appimage_startup_env_overrides_with(), log_startup_result() (+16 more)

### Community 577 - "Community 577"
Cohesion: 0.14
Nodes (23): count_worktree_lines(), DiffStats, discard_file_changes(), ensure_path_within_vault(), FileChangeStatus, get_modified_files(), load_diff_stats(), load_file_status() (+15 more)
...
Cohesion: 0.17
Nodes (10): buildDefIndex(), wrapIndex(), makeIndexes(), buildMethodDispatchIndex(), wrapIndex(), buildModuleScopeIndex(), wrapIndex(), buildQualifiedNameIndex() (+2 more)
...
Cohesion: 0.18
Nodes (21): createAgentCommand(), displayAgentSummary(), displayCompactAgentList(), displayDetailedAgentList(), formatRelativeTime(), getHealthDisplay(), getStatusColor(), getStatusDisplay() (+13 more)
...
Cohesion: 0.18
Nodes (4): getPluginManager(), PluginManager, resetPluginManager(), validatePackageName()
...
Cohesion: 0.15
Nodes (19): trigger_menu_command(), update_menu_state(), build_app_menu(), build_edit_menu(), build_file_menu(), build_go_menu(), build_note_menu(), build_vault_menu() (+11 more)
...
Cohesion: 0.15
Nodes (7): createAgenticFlowBridge(), getDefaultBridge(), resetDefaultBridge(), createAttentionCoordinator(), benchmark(), quickStart(), IntegrationError
...
Cohesion: 0.15
Nodes (16): containsWikilinks(), addTagValues(), buildVisiblePropertyEntries(), coerceNumberValue(), coerceValue(), collectAllVaultTags(), isHiddenPropertyKey(), isVisibleProperty() (+8 more)
...
Cohesion: 0.14
Nodes (13): isCommentLine(), isContinuationLine(), mergeLogicalLines(), parseCopyStatements(), parseReplacingClause(), parseSingleCopyStatement(), stripInlineComment(), extractCobolSymbolsWithRegex() (+5 more)
...
Cohesion: 0.15
Nodes (3): EventSubscription, numberToPriority(), priorityToNumber()

### Community 670 - "Community 670"
Cohesion: 0.15
Nodes (13): dateLocale(), formatDate(), countWords(), extractBacklinkContext(), extractOutgoingLinks(), extractSnippet(), injectWikilinks(), preProcessWikilinks() (+5 more)

### Community 671 - "Community 671"
Cohesion: 0.19
Nodes (18): persistModeOverride(), usePropertyPanelState(), detectPropertyType(), detectStringType(), formatDateValue(), getEffectiveDisplayMode(), isColorString(), isDateKey() (+10 more)

### Community 672 - "Community 672"
Cohesion: 0.19
Nodes (19): buildBaseCommands(), buildFolderCommands(), buildNavigationCommands(), canRunFolderCommand(), insertInboxCommand(), buildCoreNoteCommands(), buildDestructiveNoteCommands(), buildFileActionCommands() (+11 more)
...
Cohesion: 0.11
Nodes (7): Product, ProductService, UserService, Test successful user creation, Test retrieving user by ID, TestUserService, user_service()
...
Cohesion: 0.21
Nodes (21): assert_resolve_conflict_strategy(), get_conflict_files(), get_conflict_mode(), git_commit_conflict_resolution(), git_resolve_conflict(), is_merge_in_progress(), is_rebase_in_progress(), setup_conflict_pair() (+13 more)
...
Cohesion: 0.11
Nodes (11): ConfigManager, Central configuration manager., Setup default validation rules., Remove a configuration source., Merge all configuration sources by priority., Deep merge two dictionaries., Get configuration value with optional default., Set configuration value at runtime. (+3 more)
...
Cohesion: 0.21
Nodes (6): createBrowserService(), createBrowserSwarm(), postBrowseHook(), preBrowseHook(), getReasoningBank(), getAdapter()
...
Cohesion: 0.16
Nodes (8): LearningBridge, createFailingNeuralLoader(), createMockBackend(), createMockNeuralSystem(), createNeuralLoader(), createTestEntry(), createTestInsight(), seedTrajectories()
...
Cohesion: 0.18
Nodes (7): CircuitBreakerOpenError, RateLimiter, calculateBackoffDelay(), createRetryState(), sleep(), withRetry(), withTimeout()

### Community 730 - "Community 730"
Cohesion: 0.16
Nodes (13): buildEntryLookup(), buildInspectorLinkIndex(), collectMatchedPaths(), findMatchedEntries(), getEntryPathSuffixes(), getInspectorLinkIndex(), indexBacklinkEntries(), indexReferencedByEntries() (+5 more)
...
Cohesion: 0.13
Nodes (12): createVersionInfo(), formatReleaseDisplayVersion(), restartApp(), installInvokeHandlers(), performManualCheck(), renderUpdater(), toAvailableStatus(), useUpdater() (+4 more)

### Community 734 - "Community 734"
Cohesion: 0.18
Nodes (16): getNoteContentCommandPayload(), resolveNoteWindowEntry(), findNoteWindowEntry(), getCurrentWindowLabel(), getNoteWindowLabel(), getNoteWindowParams(), getNoteWindowPathCandidates(), getStoredNoteWindowParams() (+8 more)
...
Cohesion: 0.19
Nodes (17): CommitFailure, git_commit(), is_commit_signing_failure(), run_commit(), test_commit_nothing_to_commit_returns_error(), test_git_commit(), test_git_commit_retries_without_signing_when_gpg_is_missing(), get_file_diff() (+9 more)
...
Cohesion: 0.12
Nodes (10): AnalyzeOnboarding(), handleAutoConnect(), AppStateProvider(), useBackend(), BackendError, connectHeartbeat(), fetchRepos(), normalizeServerUrl() (+2 more)
...
Cohesion: 0.15
Nodes (13): StatusPill(), copyLegacyAppStorageKeys(), getAppStorageItem(), wasDismissed(), loadCollapsedState(), migrateLocalStorageToVaultConfig(), readJson(), getMappedStatusStyle() (+5 more)
...
Cohesion: 0.1
Nodes (3): test_created_at_from_filesystem(), test_no_type_when_frontmatter_missing(), test_type_from_frontmatter_only()
...
Cohesion: 0.11
Nodes (10): CircularBuffer, Memory-efficient circular buffer for logging and history., Add item to the buffer., Get most recent items., Get all items in buffer., Get current buffer size., Get total items written to buffer., Get cache statistics. (+2 more)
...
Cohesion: 0.14
Nodes (10): Generate meta-features from base model predictions, Make predictions using meta-model, Probability predictions for classification, Make predictions using gated mixture of experts, Make Bayesian averaged predictions, Optimize which models to include in ensemble, Make weighted predictions, Advanced stacking ensemble with meta-learner (+2 more)
...
Cohesion: 0.22
Nodes (15): ensureInitialized(), ensureMemoryDir(), getLegacyPath(), getMemoryDir(), getMemoryFunctions(), getMigrationMarkerPath(), hasLegacyStore(), loadLegacyStore() (+7 more)
...
Cohesion: 0.2
Nodes (17): serializeBlock(), compactMarkdown(), decodeHtmlEntities(), endsWithHardBreakMarker(), finalizeMarkdown(), findNextNonBlank(), findPrevNonBlank(), isBlankBetweenListItems() (+9 more)

### Community 819 - "Community 819"
Cohesion: 0.15
Nodes (8): droppedNoteWikilinkTarget(), NoteDropHarness(), useNoteWikilinkDrop(), DraggableNoteItem(), clearDraggedNotePath(), readDraggedNotePath(), writeDraggedNotePath(), NoteDropTarget()
...
Cohesion: 0.25
Nodes (16): loadFTSExtension(), checkin(), checkout(), closeLbug(), closeOne(), createConnection(), doInitLbug(), ensureIdleTimer() (+8 more)
...
Cohesion: 0.15
Nodes (8): Time-to-live cache implementation., Start background cleanup task., Set a key-value pair with TTL., Get value by key if not expired., Evict least recently used item., Remove key from cache and expiry tracking., Remove expired entries., TTLMap
...
Cohesion: 0.24
Nodes (16): delete_vault_folder(), folder_commands_route_through_vault_path_boundary(), rename_vault_folder(), delete_folder(), delete_folder_rejects_missing_folder(), delete_folder_removes_nested_contents(), display_relative_path(), ensure_relative_folder_path() (+8 more)
...
Cohesion: 0.15
Nodes (10): BaseEstimator, BayesianModelAveraging, MixtureOfExpertsEnsemble, Mixture of Experts ensemble with gating network, Fit experts and gating network, Evaluate each expert's performance on each sample, Bayesian Model Averaging ensemble, Fit models and compute posterior weights (+2 more)
...
Cohesion: 0.18
Nodes (5): createSwarmHub(), getSwarmHub(), resetSwarmHub(), createTaskOrchestrator(), EventBus

### Community 896 - "Community 896"
Cohesion: 0.16
Nodes (4): SecuritySandbox, parseOrThrow(), parseWithDefaults(), validateInput()

### Community 897 - "Community 897"
Cohesion: 0.14
Nodes (3): AgentHandleImpl, QECoreError, TaskHandleImpl
...
Cohesion: 0.14
Nodes (3): cosineSimilarity(), createHnswBridge(), HnswBridge

### Community 913 - "Community 913"
Cohesion: 0.15
Nodes (8): applyToModules(), loadFromStorage(), saveToStorage(), storageKey(), useVaultConfig(), initDisplayModeOverrides(), initStatusColors(), initTagColors()
...
Cohesion: 0.21
Nodes (16): assert_relationship_values(), parse_big_project_relationships(), parse_skip_key_relationships(), test_parse_large_notes_relationship_array(), test_parse_relationships_array(), test_parse_relationships_builtin_wikilink_fields(), test_parse_relationships_custom_fields(), test_parse_relationships_ignores_non_wikilinks() (+8 more)
...
Cohesion: 0.12
Nodes (8): Aggregate metrics from all sources., Aggregate performance collector metrics., Aggregate resource monitor metrics., Aggregate process tracker metrics., Calculate system-wide metrics., Aggregate results into benchmark metrics., Save comprehensive metrics report., Stop collection and return aggregated metrics.
...
Cohesion: 0.22
Nodes (9): createCheckpointStorage(), createLongRunningWorker(), createBackendWorker(), createFrontendWorker(), createSpecializedWorker(), createTestingWorker(), createAndInitializeWorkerPool(), createWorkerPool() (+1 more)
...
Cohesion: 0.24
Nodes (14): shouldSyncFrontmatterState(), collapseList(), detectFrontmatterState(), extractFrontmatterBody(), flushList(), isBlockScalar(), isInlineArrayLiteral(), parseFrontmatter() (+6 more)
...
Cohesion: 0.3
Nodes (13): buildAdjacency(), buildTransitiveEdgeTypes(), computeMRO(), emitMethodImplementsEdges(), findInheritedMethod(), parameterTypesMatch(), resolveByMroOrder(), resolveCsharpJava() (+5 more)
...
Cohesion: 0.15
Nodes (8): ConfigLoader, Configuration file loader supporting multiple formats., Load configuration from file., Load JSON configuration., Load YAML configuration., Load TOML configuration., Load environment file configuration., Load Python configuration file.
...
Cohesion: 0.17
Nodes (11): DataHandler, FeatureEngineer, main(), PerformanceTracker, MLE-STAR Foundation Agent - Enhanced Implementation Advanced Foundation Model Bu, Handle various data formats and sources, Load data from various formats, Advanced feature engineering (+3 more)

### Community 991 - "Community 991"
Cohesion: 0.16
Nodes (8): DynamicWeightingEnsemble, EnsembleOptimizer, MLE-STAR Ensemble Agent Implementation Sophisticated model ensemble strategies f, Dynamic weighting ensemble with adaptive weight calculation, Fit all models and compute dynamic weights, Main ensemble optimization class, Create an ensemble with specified strategy, Compute weights based on model performance
...
Cohesion: 0.25
Nodes (5): buildAdjacencyMatrix(), cosineSimilarity(), createNodeFeatures(), main(), GATLayer
...
Cohesion: 0.22
Nodes (10): extractH1Content(), getH1TextFromBlocks(), hasLocalFileUrl(), hasSyntheticPreviewWidth(), isParsedBlock(), normalizeParsedBlockChildren(), normalizeParsedImageBlock(), shouldClearLocalImagePreviewWidth() (+2 more)
...
Cohesion: 0.15
Nodes (11): data_pipeline_structure(), mock_ensemble_results(), mock_result(), mock_time_series_data(), pytest_collection_modifyitems(), Pytest configuration and shared fixtures for benchmark tests.  Provides common t, Create a data pipeline project structure for testing., Provide mock result for testing. (+3 more)

### Community 1064 - "Community 1064"
Cohesion: 0.15
Nodes (12): mock_execution_log(), mock_sqlite_db(), performance_baseline(), pytest_configure(), Provide mock SQLite database for testing., Provide performance baseline metrics., Configure pytest with custom markers and settings., Provide mock execution log. (+4 more)
...
Cohesion: 0.33
Nodes (11): calculateRecall(), cosineSimilarity(), dequantizeInt4(), dequantizeInt8(), exactTopK(), generateVectors(), hammingDistance(), main() (+3 more)
...
Cohesion: 0.22
Nodes (8): validate_view_filename(), is_invalid_portable_name_segment(), is_windows_reserved_device_name(), validate_filename_stem(), validate_folder_name(), validate_portable_name_segment(), validate_view_filename_stem(), normalize_filename_stem()

### Community 1109 - "Community 1109"
Cohesion: 0.17
Nodes (13): check_claude_cli(), check_cli(), check_cli_returns_status(), claude_path_lookup_command(), command_path_from_shell(), find_claude_binary(), find_claude_binary_in_user_shell(), find_claude_binary_on_path() (+5 more)
...
Cohesion: 0.26
Nodes (12): extract_snippet(), score_match(), search_vault(), SearchResponse, SearchResult, test_extract_snippet_basic(), test_extract_snippet_long(), test_extract_snippet_no_match() (+4 more)
...
Cohesion: 0.17
Nodes (7): Real hive-mind benchmark scenarios., Initialize real hive-mind benchmark., Run real hive-mind with ./claude-flow and measure performance., Benchmark collective intelligence mode., Benchmark swarm with shared memory., Initialize benchmark suite., RealHiveMindBenchmark
...
Cohesion: 0.18
Nodes (6): Test user validation rules, Test user to dict conversion, Test product creation, Test user creation with valid data, TestProductModel, TestUserModel
...
Cohesion: 0.21
Nodes (7): EnhancedFoundationAgent, Generate comprehensive results report, Get summary of preprocessing steps, Extract feature importance if available, Generate actionable recommendations, Coordinate handoff to next agent, Enhanced MLE-STAR Foundation Agent          Advanced features:     - Multi-datas
...
Cohesion: 0.39
Nodes (10): calculateRequiredVotes(), detectByzantineVoters(), ensureHiveDir(), getHiveDir(), getHivePath(), loadAgentStore(), loadHiveState(), saveAgentStore() (+2 more)
...
Cohesion: 0.26
Nodes (4): executeWithBridge(), OfficialHooksBridge, outputOfficialHookResult(), processOfficialHookInput()
...
Cohesion: 0.25
Nodes (6): BenchmarkComparator, main(), Compare multiple benchmark reports., Main entry point for benchmark comparison., Run multiple benchmarks for comparison., Generate detailed comparison report.
...
Cohesion: 0.18
Nodes (6): ModelBuilder, Optimize hyperparameters for best models, Get appropriate scoring metric, Build and manage models, Get baseline models based on configuration, Get hyperparameter grid for model
...
Cohesion: 0.33
Nodes (9): fallbackAnalyze(), formatComplexityValueAst(), getComplexityRatingAst(), getGraphAnalyzer(), getRiskDisplay(), getStatusDisplay(), getTypeMarkerAst(), scanSourceFiles() (+1 more)
...
Cohesion: 0.33
Nodes (9): createMCPRequest(), createMCPResponse(), createMCPServerConfig(), createMCPSessionContext(), createMCPTool(), createMCPToolResult(), createMockMCPClient(), createMockMCPServer() (+1 more)
...
Cohesion: 0.2
Nodes (5): Auto-detect configuration format from file extension., Notify watchers of configuration changes., Export merged configuration to string., Save merged configuration to file., Get configuration value.

### Community 1249 - "Community 1249"
Cohesion: 0.2
Nodes (6): AsyncFileManager, Async file operations manager for I/O optimization., Write JSON data to file asynchronously., Read JSON data from file asynchronously., Write text content to file asynchronously., Initialize optimized engine wrapping base engine.
...
Cohesion: 0.6
Nodes (8): agentBoosterCommand(), batchEdit(), callAgentBooster(), detectLanguage(), editFile(), parseMarkdown(), runBenchmark(), showBoosterHelp()
...
Cohesion: 0.56
Nodes (8): configureProxy(), getProxyLogs(), getProxyStatus(), proxyCommand(), restartProxy(), showProxyHelp(), startProxy(), stopProxy()
...
Cohesion: 0.2
Nodes (10): build_agent_args(), build_agent_args_basic(), build_agent_args_empty_system_prompt_is_skipped(), build_agent_args_with_system_prompt(), build_mcp_config(), build_mcp_config_is_valid_json(), run_agent_stream(), run_agent_stream_returns_result() (+2 more)
...
Cohesion: 0.25
Nodes (4): MixinSession, openai_tools_to_claude(), [{type:'function', function:{name,description,parameters}}] → [{name,description, Multi-session fallback with spring-back to primary.
...
Cohesion: 0.53
Nodes (5): cleanupAllCaches(), cleanupCaches(), createIsolatedCache(), getIsolatedNpxEnv(), registerCleanup()

### Community 1326 - "Community 1326"
Cohesion: 0.31
Nodes (3): getDevOpsOrchestration(), createSparcPrompt(), getModeOrchestration()
...
Cohesion: 0.28
Nodes (3): createHyperbolicBridge(), cosineSimilarity(), createSonaBridge()
...
Cohesion: 0.31
Nodes (4): createSwapHarness(), flushEditorTick(), installEditorDomSpies(), makeMockEditor()
...
Cohesion: 0.31
Nodes (6): test_non_markdown_files_use_expected_titles_and_kinds(), test_scan_vault_folders_excludes_hidden(), test_scan_vault_folders_flat_vault(), test_scan_vault_folders_keeps_default_vault_folders_visible(), test_scan_vault_folders_returns_tree(), scan_vault_folders()
...
Cohesion: 0.29
Nodes (5): OptimizedBenchmarkEngine, Optimized benchmark engine with real performance enhancements.          Features, Enable all optimization features., Run benchmark with all optimizations enabled., Process multiple objectives in optimized batches.

### Community 1399 - "Community 1399"
Cohesion: 0.39
Nodes (6): main(), Simulate benchmark results based on configuration., Update GitHub issue with comment., Run simulated benchmarks and update GitHub issue., simulate_benchmark(), update_github_issue()
...
Cohesion: 0.54
Nodes (7): main(), ms(), norm(), pcent(), pct(), runAnthropicBaseline(), runLlmBaseline()
...
Cohesion: 0.52
Nodes (5): main(), Run a real swarm benchmark.          Args:         task: Task description, Run multiple swarm benchmarks with different configurations., run_multiple_benchmarks(), run_swarm_benchmark()
...
Cohesion: 0.48
Nodes (5): formatClaimant(), formatDuration(), formatStatus(), parseClaimant(), createClaimService()
...
Cohesion: 0.33
Nodes (3): Get advanced configuration with sensible defaults, Setup Claude Flow coordination, Initialize Enhanced Foundation Agent                  Args:             task_typ

### Community 1578 - "Community 1578"
Cohesion: 0.33
Nodes (3): Build and evaluate baseline models, Store individual model performance, Comprehensive model evaluation
...
Cohesion: 0.7
Nodes (4): create_test_file(), falls_back_to_legacy_relationship_keys_when_snake_case_is_absent(), parse_test_entry(), prefers_snake_case_relationship_keys_for_convenience_fields()
...
- **1393 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `string` connect `Community 82` to `Community 1`, `Community 3`, `Community 1028`, `Community 4`, `Community 5`, `Community 1031`, `Community 520`, `Community 10`, `Community 524`, `Community 13`, `Community 14`, `Community 15`, `Community 1039`, `Community 20`, `Community 23`, `Community 26`, `Community 27`, `Community 1050`, `Community 540`, `Community 542`, `Community 31`, `Community 33`, `Community 35`, `Community 36`, `Community 37`, `Community 547`, `Community 551`, `Community 39`, `Community 557`, `Community 46`, `Community 48`, `Community 49`, `Community 560`, `Community 1587`, `Community 561`, `Community 53`, `Community 565`, `Community 56`, `Community 569`, `Community 1594`, `Community 1595`, `Community 1596`, `Community 1593`, `Community 1086`, `Community 70`, `Community 71`, `Community 72`, `Community 1100`, `Community 589`, `Community 78`, `Community 79`, `Community 81`, `Community 594`, `Community 595`, `Community 596`, `Community 85`, `Community 86`, `Community 87`, `Community 600`, `Community 605`, `Community 94`, `Community 95`, `Community 98`, `Community 105`, `Community 106`, `Community 107`, `Community 108`, `Community 623`, `Community 1136`, `Community 114`, `Community 628`, `Community 118`, `Community 119`, `Community 1144`, `Community 1145`, `Community 122`, `Community 630`, `Community 631`, `Community 636`, `Community 126`, `Community 637`, `Community 129`, `Community 130`, `Community 131`, `Community 645`, `Community 133`, `Community 647`, `Community 136`, `Community 135`, `Community 134`, `Community 651`, `Community 652`, `Community 653`, `Community 142`, `Community 140`, `Community 1171`, `Community 661`, `Community 150`, `Community 151`, `Community 153`, `Community 154`, `Community 667`, `Community 156`, `Community 671`, `Community 160`, `Community 162`, `Community 164`, `Community 165`, `Community 1193`, `Community 684`, `Community 685`, `Community 174`, `Community 175`, `Community 687`, `Community 177`, `Community 686`, `Community 690`, `Community 172`, `Community 693`, `Community 182`, `Community 1207`, `Community 184`, `Community 1208`, `Community 697`, `Community 187`, `Community 699`, `Community 189`, `Community 700`, `Community 191`, `Community 192`, `Community 706`, `Community 195`, `Community 197`, `Community 1736`, `Community 203`, `Community 204`, `Community 1230`, `Community 210`, `Community 212`, `Community 726`, `Community 216`, `Community 729`, `Community 731`, `Community 225`, `Community 228`, `Community 230`, `Community 236`, `Community 750`, `Community 239`, `Community 1265`, `Community 241`, `Community 757`, `Community 760`, `Community 250`, `Community 765`, `Community 256`, `Community 257`, `Community 1282`, `Community 259`, `Community 260`, `Community 769`, `Community 768`, `Community 773`, `Community 776`, `Community 266`, `Community 268`, `Community 1293`, `Community 1294`, `Community 271`, `Community 280`, `Community 793`, `Community 1309`, `Community 800`, `Community 803`, `Community 807`, `Community 296`, `Community 302`, `Community 308`, `Community 309`, `Community 824`, `Community 312`, `Community 313`, `Community 315`, `Community 320`, `Community 321`, `Community 1346`, `Community 833`, `Community 322`, `Community 1345`, `Community 1344`, `Community 325`, `Community 323`, `Community 842`, `Community 332`, `Community 848`, `Community 338`, `Community 851`, `Community 1364`, `Community 855`, `Community 859`, `Community 860`, `Community 351`, `Community 354`, `Community 870`, `Community 874`, `Community 878`, `Community 879`, `Community 366`, `Community 375`, `Community 1919`, `Community 1412`, `Community 1416`, `Community 1417`, `Community 1418`, `Community 1419`, `Community 401`, `Community 402`, `Community 914`, `Community 404`, `Community 407`, `Community 408`, `Community 1202`, `Community 417`, `Community 419`, `Community 421`, `Community 936`, `Community 937`, `Community 938`, `Community 939`, `Community 424`, `Community 428`, `Community 433`, `Community 434`, `Community 438`, `Community 439`, `Community 440`, `Community 442`, `Community 961`, `Community 963`, `Community 452`, `Community 453`, `Community 454`, `Community 971`, `Community 1491`, `Community 1492`, `Community 1493`, `Community 474`, `Community 989`, `Community 482`, `Community 995`, `Community 996`, `Community 997`, `Community 1510`, `Community 491`, `Community 492`, `Community 494`, `Community 495`, `Community 498`, `Community 503`?**
  _High betweenness centrality (0.510) - this node is a cross-community bridge._
- **Why does `swarmCommand()` connect `Community 184` to `Community 104`, `Community 82`?**
  _High betweenness centrality (0.080) - this node is a cross-community bridge._
- **Why does `max()` connect `Community 111` to `Community 1`, `Community 644`, `Community 6`, `Community 7`, `Community 395`, `Community 141`, `Community 143`, `Community 17`, `Community 18`, `Community 19`, `Community 22`, `Community 1251`, `Community 152`, `Community 25`, `Community 410`, `Community 411`, `Community 28`, `Community 923`, `Community 158`, `Community 157`, `Community 1184`, `Community 1568`, `Community 1061`, `Community 678`, `Community 38`, `Community 167`, `Community 679`, `Community 40`, `Community 170`, `Community 45`, `Community 1070`, `Community 430`, `Community 304`, `Community 1069`, `Community 50`, `Community 51`, `Community 54`, `Community 55`, `Community 314`, `Community 58`, `Community 60`, `Community 61`, `Community 445`, `Community 831`, `Community 449`, `Community 67`, `Community 584`, `Community 585`, `Community 712`, `Community 462`, `Community 80`, `Community 90`, `Community 91`, `Community 93`, `Community 609`, `Community 1250`, `Community 611`, `Community 484`, `Community 485`, `Community 742`, `Community 486`, `Community 743`, `Community 102`, `Community 1889`, `Community 1131`, `Community 613`, `Community 101`, `Community 1132`, `Community 618`, `Community 240`, `Community 1140`, `Community 117`, `Community 1399`, `Community 378`, `Community 638`, `Community 127`?**
