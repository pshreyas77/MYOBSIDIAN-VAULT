# Graph Report - ObsidianVault  (2026-07-21)

## Corpus Check
- 9236 files · ~16,746,307 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 50137 nodes · 97449 edges · 3916 communities (2519 shown, 1397 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 4507 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `afaad418`
...
## Communities (3916 total, 1397 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (242): BaseStrategy, BenchmarkEngine, BenchmarkEngine, Execute a batch of tasks., Main engine for running swarm benchmarks., Initialize the benchmark engine., Submit a task to the benchmark queue., Agent (+234 more)
...
Cohesion: 0.02
Nodes (55): createAnalystAgent(), createArchitectAgent(), createAgentFactory(), createResearcherAgent(), DeliveryManager, MessageRouter, EventBus, generateSecureEventId() (+47 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (106): handleMessage(), formatHealthStatus(), formatLogLevel(), formatStatus(), getAgentCapabilities(), updateSwarmActivityMetrics(), fallbackAnalyze(), formatComplexityValueAst() (+98 more)
...
Cohesion: 0.03
Nodes (119): ensureAgentDir(), getAgentDir(), getAgentPath(), loadAgentStore(), saveAgentStore(), sanitizeError(), validatePositiveInt(), validateScore() (+111 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (117): ABC, AdaptiveStrategy, AggressiveStrategy, ConfidenceLevel, DecisionContext, DecisionCriteria, DecisionOption, DecisionResult (+109 more)
...
Cohesion: 0.04
Nodes (33): createCoderAgent(), createCoordinatorAgent(), createTesterAgent(), MCPClient, CircuitBreaker, LoadBalancer, RateLimiter, getServerCapabilities() (+25 more)
...
Cohesion: 0.04
Nodes (72): createClaudeSlashCommands(), copyAgentFiles(), copyCommandFiles(), createAgentDirectories(), validateAgentSystem(), batchInitCommand(), batchInitFromConfig(), BatchProgressTracker (+64 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (64): createKnowledgeGraph(), buildTestGraph(), createMinimalTestGraph(), buildSuffixIndex(), createASTCache(), BindingAccumulator, enrichExportedTypeMap(), buildExportedTypeMapFromGraph() (+56 more)

### Community 13 - "Community 13"
Cohesion: 0.05
Nodes (50): createCallExtractor(), createClassExtractor(), extractScopeSegmentsFromNode(), normalizeQualifiedName(), splitQualifiedName(), createFieldExtractor(), createHeritageExtractor(), createImportResolver() (+42 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (19): IoTCoordinator, InMemoryDeviceRepository, InMemoryFleetRepository, InMemoryTrustHistoryRepository, createMcpTools(), textResult(), createMockCoordinator(), makeCoordinator() (+11 more)
...
Cohesion: 0.03
Nodes (19): MCPAsyncJobManager, MemoryJobPersistence, executor(), executor(), createMCPServer(), MCPServerFactory, MCP2025Server, createProgressiveClaudeFlowSdkServer() (+11 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (18): CompletionGenerator, handleError(), setupLogging(), setupSignalHandlers(), getAnalyticsManager(), getAuditManager(), getCloudManager(), getDeploymentManager() (+10 more)
...
Cohesion: 0.02
Nodes (74): create_cross_topic_links(), create_file_index(), create_master_topics_index(), create_moc_file(), extract_topics_from_file(), get_all_files(), organize_by_topics(), Extract topics from file content and name (+66 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (17): quickStart(), createMCPServer(), createSessionManager(), createToolRegistry(), defineTool(), MCPServerError, createHttpTransport(), HttpTransport (+9 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (77): ensureAndParse(), findDeclarationNode(), findFunctionNode(), extractFieldNames(), extractMethodNames(), extractStructuralNames(), extractFetchCallsFromFiles(), findEnclosingFunction() (+69 more)
...
Cohesion: 0.03
Nodes (41): extractCppMethodName(), extractCppParameters(), extractCppReturnType(), extractCVarType(), extractFieldType(), extractParamName(), findFunctionDeclarator(), hasVirtualSpecifier() (+33 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (49): applyPreset(), handleReset(), handleSave(), CommunicationLog(), DependencyGraph(), PlanVisualization(), QualityGates(), RealTimeEventLog() (+41 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (61): resolveDisplayInfo(), InlineWikilinkChipView(), getTypeIcon(), QuickOpenPalette(), SearchPanel(), resolveSectionColors(), toResult(), useNoteSearch() (+53 more)
...
Cohesion: 0.04
Nodes (73): consensus_swarm(), hive_benchmark(), knowledge_swarm(), MockHiveMindBenchmark, MockSwarm, MockSwarmAgent, Unit tests for collective intelligence benchmarking.  Tests the hive mind benchm, Mock swarm for testing collective intelligence. (+65 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (80): buildReceiverTypeIndex(), collectExportedBindings(), countCallableCandidates(), dedupSwiftExtensionCandidates(), defaultDispatchDecision(), disambiguateByOverloadOrArgTypes(), extractConsumerAccessedKeys(), extractFuncNameFromSourceId() (+72 more)
...
Cohesion: 0.06
Nodes (64): fileExists(), findSectionMarkerIndex(), generateAIContextFiles(), generateGitNexusContent(), installSkills(), upsertGitNexusSection(), analyzeCommand(), ensureHeap() (+56 more)

### Community 48 - "Community 48"
Cohesion: 0.03
Nodes (71): Extract metrics from command output., fold_turns(), init(), Return list of segments: [{'type':'text','content':...}, {'type':'fold','title':, render_sidebar(), _reset_and_rerun(), _function(), int() (+63 more)
...
Cohesion: 0.04
Nodes (42): readSafe(), buildProtoContext(), buildProtoMap(), contractId(), extractServiceBlocks(), GrpcExtractor, makeContract(), normalizeProtoPath() (+34 more)
...
Cohesion: 0.03
Nodes (53): AggregatedMetric, MetricAggregator, MetricCollector, MetricDefinition, MetricPoint, MetricType, Metric Aggregator  Real-time metric collection and aggregation system for Claude, Collect counter metric. (+45 more)
...
Cohesion: 0.06
Nodes (57): cwd(), exit(), printError(), printInfo(), printSuccess(), printWarning(), createGitHubCheckpointHooks(), createGitHubSettingsJson() (+49 more)

### Community 56 - "Community 56"
Cohesion: 0.04
Nodes (24): getDefaultCollectionManager(), setDefaultCollectionManager(), validatePlugin(), validatePluginMetadata(), getAllOfficialPlugins(), getOfficialCollection(), getDefaultRegistry(), setDefaultRegistry() (+16 more)
...
Cohesion: 0.05
Nodes (64): batch_config(), batch_processor(), MockBatchConfig, MockBatchProcessor, MockBenchmarkTask, MockPipeline, MockPipelineManager, MockPipelineStage (+56 more)

### Community 60 - "Community 60"
Cohesion: 0.04
Nodes (23): AgentManager, createAgentCommand(), displayAgentSummary(), displayCompactAgentList(), displayDetailedAgentList(), formatRelativeTime(), getHealthDisplay(), getStatusColor() (+15 more)
...
Cohesion: 0.03
Nodes (13): CrossModalAttention, GraphAttention, HyperbolicAttention, KNNAttention, MixtureOfExpertsAttention, PerceiverAttention, RecurrentAttention, RetrievalAttention (+5 more)

### Community 66 - "Community 66"
Cohesion: 0.06
Nodes (52): findGroupsContainingRegistryName(), checkStaleness(), bridgeExists(), closeBridgeDb(), contractNodeId(), createContractLookupIndex(), ensureBridgeSchema(), errMessage() (+44 more)
...
Cohesion: 0.03
Nodes (43): initializeAgentSystem(), getUser(), User(), User, UserService, delete_frontmatter_property(), test_delete_frontmatter_block_scalar(), test_roundtrip_add_then_delete() (+35 more)
...
Cohesion: 0.05
Nodes (47): csharpNamespaceStrategy(), dartPackageStrategy(), dartRelativeStrategy(), goPackageStrategy(), javaJvmStrategy(), kotlinJvmStrategy(), phpPsr4Strategy(), pythonImportStrategy() (+39 more)
...
Cohesion: 0.05
Nodes (15): BdBridgeError, createBdBridge(), SyncBridgeError, createLazyConvoyObserver(), getLazyObserverStats(), AsyncLazy, BatchDeduplicator, DebouncedEmitter (+7 more)
...
Cohesion: 0.03
Nodes (52): Run a comprehensive demonstration of all features., run_comprehensive_demo(), Run a benchmark and display the improved report., run_benchmark_with_report(), main(), Run focused hive-mind benchmarks., Run focused SPARC benchmarks., Run comprehensive real benchmark suite. (+44 more)
...
Cohesion: 0.05
Nodes (16): BidirectionalAttention, ChunkAttention, configure(), constructor(), CrossAttention, DilatedAttention, FlashAttention, FlashAttentionV2 (+8 more)

### Community 96 - "Community 96"
Cohesion: 0.04
Nodes (43): getConnectErrorMessage(), shouldCloseAfterResult(), submitRemoteConnection(), tauriCall(), tauriCall(), tauriCall(), useClaudeCodeStatus(), commitMergeResolution() (+35 more)
...
Cohesion: 0.03
Nodes (45): MetricsAggregator, Create a named resource monitor., Get the process tracker instance., Aggregate metrics from all sources., Aggregate performance collector metrics., Aggregate resource monitor metrics., Aggregate process tracker metrics., Calculate system-wide metrics. (+37 more)
...
Cohesion: 0.07
Nodes (42): formatDuration(), formatProgressBar(), formatStatusIndicator(), checkMCPStatus(), createMCPCommand(), printError(), printSuccess(), getCLIBridge() (+34 more)
...
Cohesion: 0.04
Nodes (66): Formatter, addIssueToContext(), assertNever(), cleanRegex(), datetimeRegex(), deserializeMessage(), dirty(), endsWith() (+58 more)
...
Cohesion: 0.05
Nodes (39): enforce_rate_limit(), get_remaining_slots(), Canonical implementation in the backend root., Another function in middleware., Estimate time remaining based on average task time., Main monitoring loop., max(), Get hybrid coordination metrics.                  Returns:             Dictionar (+31 more)
...
Cohesion: 0.07
Nodes (33): createDiscoveryService(), createDownloader(), createPatternStore(), PatternStore, checkContributionStatus(), createPublisher(), quickPublish(), submitContribution() (+25 more)
...
Cohesion: 0.08
Nodes (16): ensureAgentDBImport(), buildGraph(), buildGraphEntries(), createMockBackend(), createMockNeural(), makeEntry(), createMockBackend(), mockEmbedding() (+8 more)
...
Cohesion: 0.07
Nodes (19): createHyperbolicBridge(), HyperbolicBridge, createTestSonaBridge(), initializePlugin(), validateConfig(), embedHierarchyHandler(), entailmentGraphHandler(), getGnnBridge() (+11 more)
...
Cohesion: 0.08
Nodes (45): AgentLoader, getAgent(), getAgentCategories(), getAgentsByCategory(), getAllAgents(), getAvailableAgentTypes(), isValidAgentType(), refreshAgents() (+37 more)
...
Cohesion: 0.07
Nodes (41): embedQuery(), getEmbeddingDims(), initEmbedder(), isEmbedderReady(), embedBatch(), embeddingToArray(), embedText(), getEmbedder() (+33 more)
...
Cohesion: 0.09
Nodes (52): createGtBridge(), createSyncBridge(), createConvoyObserver(), createFormulaExecutor(), createGasTownBridgePlugin(), createPluginLogger(), getToolsByLayer(), validateBead() (+44 more)

### Community 159 - "Community 159"
Cohesion: 0.06
Nodes (37): buildSettingsFromDraft(), createSettingsDraft(), resolveAnonymousId(), resolveSettingsDraftThemeMode(), resolveTelemetryConsent(), sanitizePositiveInteger(), SettingsPanel(), invokeNativeIfAvailable() (+29 more)
...
Cohesion: 0.06
Nodes (56): AgentStreamRequest, build_chat_args(), build_chat_args_basic(), build_chat_args_empty_system_prompt_is_skipped(), build_chat_args_with_session_id(), build_chat_args_with_system_prompt(), ChatStreamRequest, ClaudeCliStatus (+48 more)

### Community 165 - "Community 165"
Cohesion: 0.06
Nodes (30): BufferedCSVWriter, escapeCSVField(), escapeCSVNumber(), extractContent(), FileContentCache, isBinaryContent(), sanitizeUTF8(), streamAllCSVsToDisk() (+22 more)
...
Cohesion: 0.07
Nodes (37): buildAiAgentCommands(), explicitSwitchCommands(), restoreGuidanceCommands(), getPromptCopy(), useAiAgentPreferences(), tauriCall(), useAiAgentsStatus(), createAiAgentAvailability() (+29 more)
...
Cohesion: 0.06
Nodes (36): description(), name(), Analysis strategy for data analysis and insights., description(), name(), Auto strategy that automatically selects the best approach., description(), execute() (+28 more)
...
Cohesion: 0.09
Nodes (21): makeContract(), TopicExtractor, compilePatterns(), runCompiledPatterns(), scanFile(), unquoteLiteral(), compileBundle(), findFirstTypeAnnotationText() (+13 more)

### Community 177 - "Community 177"
Cohesion: 0.07
Nodes (19): computeQuantizationStats(), createQuantizer(), createRng(), deserializeQuantizer(), dot(), estimateRecall(), euclideanDistance(), identityMatrix() (+11 more)

### Community 178 - "Community 178"
Cohesion: 0.06
Nodes (8): BalancedMode, BalancedMode, BatchMode, EdgeMode, BaseModeImplementation, RealTimeMode, RealTimeMode, ResearchMode
...
Cohesion: 0.1
Nodes (5): executeParameterized(), confidenceForRelType(), LocalBackend, logQueryError(), logQueryTiming()
...
Cohesion: 0.11
Nodes (33): checkAvailability(), fetchFromIPFS(), fetchFromIPFSWithMetadata(), formatBytes(), getGatewayUrl(), getGatewayUrls(), hashContent(), isPinned() (+25 more)
...
Cohesion: 0.07
Nodes (8): PolicyEngine, TrustEvaluator, HandshakeService, RoutingService, makeDeps(), makeSession(), makeMetrics(), makeNode()
...
Cohesion: 0.07
Nodes (4): FederationNode, FederationSession, getTrustLevelLabel(), isOperationAllowed()
...
Cohesion: 0.07
Nodes (26): streamQuery(), JobManager, buildGraph(), ClientDisconnectedError, createServer(), ensureStreamIsWritable(), getNodeQuery(), isAllowedOrigin() (+18 more)
...
Cohesion: 0.05
Nodes (5): applyOverrides(), get(), set(), executeCommand(), openCommandPalette()
...
Cohesion: 0.07
Nodes (7): createSelfLearningSystem(), generateQueryHistory(), hashCode(), LearningLoop, main(), PatternRecognizer, printWorkloadAnalysis()
...
Cohesion: 0.06
Nodes (34): CommandType, execute_hive_mind_spawn(), execute_sparc_mode(), execute_swarm_benchmark(), HiveMindCommand, OutputFormat, Real Claude Flow Executor - Executes actual ./claude-flow commands with subproce, Initialize mutable defaults. (+26 more)

### Community 211 - "Community 211"
Cohesion: 0.08
Nodes (8): listCommand(), withTestLbugDB(), isTestFilePath(), PhaseTimer, cleanupOldKuzuFiles(), listRegisteredRepos(), confidenceForRelType(), pickConfidence()
...
Cohesion: 0.09
Nodes (8): RvfEmbeddingCache, validatePath(), LRUCache, RvfEmbeddingService, l2Norm(), listener(), makeEmbedding(), makeTmpDir()
...
Cohesion: 0.09
Nodes (17): TypeScriptFieldExtractor, createFieldRegistry(), makeDef(), createMethodRegistry(), createRegistrationTable(), makeDeps(), createSemanticModel(), createTypeRegistry() (+9 more)
...
Cohesion: 0.09
Nodes (26): createAttentionBridge(), createDagBridge(), createPlugin(), LegalContractsPlugin, assessRisks(), buildCategorySummary(), buildNegotiationPriorities(), buildTimeline() (+18 more)
...
Cohesion: 0.07
Nodes (4): AttentionBridge, cosineSimilarity(), createNervousSystemBridge(), NervousSystemBridge
...
Cohesion: 0.06
Nodes (12): copyDirSync(), createFixtureVaultCopy(), installFixtureVaultDesktopBridge(), openFixtureVaultDesktopHarness(), openAlphaProjectInEditor(), dispatchCommandShortcut(), focusNoteList(), selectVisibleInboxBatch() (+4 more)
...
Cohesion: 0.12
Nodes (21): createAgentBridge(), findGitRootSync(), listAgentScopes(), listAgentsInDir(), resolveAgentMemoryDir(), createMockBackend(), createTestEntry(), transferKnowledge() (+13 more)
...
Cohesion: 0.13
Nodes (11): createA2C(), createCuriosity(), createDecisionTransformer(), createDQN(), createAlgorithm(), getDefaultConfig(), createPPO(), createQLearning() (+3 more)
...
Cohesion: 0.11
Nodes (35): createAgentTable(), createTaskTable(), displayBanner(), displayVersion(), formatAgent(), formatError(), formatInfo(), formatMemoryEntry() (+27 more)
...
Cohesion: 0.05
Nodes (16): attemptClone(), repoNameFromUrl(), suggestedPathFromUrl(), tauriCall(), focusConfirmButton(), focusPrimaryDeleteButton(), handleWindowKeyDown(), isComposingEvent() (+8 more)
...
Cohesion: 0.1
Nodes (33): agents_content_can_be_refreshed(), AgentsContent, AgentsContent<'a>, assert_getting_started_vault_replaces_template(), canonical_getting_started_vault_exists(), canonical_vault_path(), create_getting_started_vault(), create_getting_started_vault_from_repo() (+25 more)

### Community 266 - "Community 266"
Cohesion: 0.06
Nodes (11): openNoteViaQuickOpen(), openQuickOpen(), openQuickOpen(), openNoteViaQuickOpen(), openQuickOpen(), openQuickOpen(), closeCommandPalette(), findCommand() (+3 more)
...
Cohesion: 0.06
Nodes (11): installFixtureVaultInitScript(), openFixtureVault(), removeFixtureVaultCopy(), removeFixtureVaultDirectory(), waitForFixtureVaultReady(), installFixtureVaultDesktopBridgeInBrowser(), noteList(), openNote() (+3 more)
...
Cohesion: 0.09
Nodes (7): ByzantineConsensus, createByzantineConsensus(), BoundedSet, createGossipConsensus(), createConsensusEngine(), selectOptimalAlgorithm(), createRaftConsensus()
...
Cohesion: 0.11
Nodes (31): CommandCompleter, CommandHistory, connectToOrchestrator(), createPrompt(), findSimilarCommands(), getConnectionStatusIcon(), handleAgentCommand(), handleAgentSpawn() (+23 more)
...
Cohesion: 0.07
Nodes (22): ClaudeFlowExecutor, Convert config to command line arguments., Convert config to command line arguments., Executor for claude-flow commands with robust error handling., Initialize the executor.                  Args:             claude_flow_path: Pa, Find the claude-flow executable., Prepare environment variables., Execute a command with proper error handling.                  Args: (+14 more)
...
Cohesion: 0.12
Nodes (21): createAgentPool(), createMessageBus(), createQueenCoordinator(), createTopologyManager(), isAgentId(), isMessage(), isTaskId(), createUnifiedSwarmCoordinator() (+13 more)
...
Cohesion: 0.1
Nodes (35): setup_remote_pair(), classify_push_error(), contains_any(), current_branch(), git_pull(), git_push(), git_remote_status(), GitPullResult (+27 more)
...
Cohesion: 0.11
Nodes (30): blockSupportsTextCursor(), findNearestTextCursorBlock(), findNearestTextCursorBlockById(), buildBlockLineRanges(), buildBlockNoteRestoreState(), buildCodeMirrorRestoreState(), captureRawEditorPositionSnapshot(), captureRichEditorPositionSnapshot() (+22 more)
...
Cohesion: 0.08
Nodes (23): assert_complex_frontmatter_case(), complex_frontmatter_cases(), FrontmatterCase, test_complex_frontmatter_preserves_type_and_organized(), test_fallback_parser_extracts_type_and_organized(), extract_fm_and_rels(), extract_properties(), extract_relationships() (+15 more)
...
Cohesion: 0.08
Nodes (3): AsyncOperationQueue, BatchProcessor, PerformanceOptimizer
...
Cohesion: 0.06
Nodes (18): Get current resource usage., Start the parallel executor., Stop the parallel executor., Submit a task for execution., Submit multiple tasks as a batch., Get all completed results., Wait for all tasks to complete., Worker coroutine that processes tasks from the queue. (+10 more)
...
Cohesion: 0.08
Nodes (3): InitController, GitHubInit, SparcInit
...
Cohesion: 0.09
Nodes (24): render(), renderEditor(), renderForMention(), renderWithEntries(), captureRawCodeMirrorRestoreState(), applyPendingRawExitContent(), buildPendingRawExitContent(), rememberPendingRawExitContent() (+16 more)
...
Cohesion: 0.09
Nodes (4): EnterpriseInit, HiveMindInit, NeuralInit, StandardInit
...
Cohesion: 0.12
Nodes (23): Command, execPath(), getDirname(), getFilename(), getImportMetaUrl(), isMainModule(), kill(), mkdirAsync() (+15 more)
...
Cohesion: 0.08
Nodes (8): AttentionRegistry, CausalAttention, MultiHeadAttention, generateRandomVectors(), main(), measure(), printVectorStats(), SelfAttention
...
Cohesion: 0.08
Nodes (4): FormulaExecutor, hashKey(), JsFallbackWasmLoader, WorkStealingQueue
...
Cohesion: 0.08
Nodes (13): applyToModules(), loadFromStorage(), saveToStorage(), storageKey(), useVaultConfig(), useViewMode(), useZoom(), initDisplayModeOverrides() (+5 more)
...
Cohesion: 0.11
Nodes (22): StatusPill(), copyLegacyAppStorageKeys(), getAppStorageItem(), wasDismissed(), loadEditorMode(), isViewMode(), loadViewMode(), configToPercent() (+14 more)
...
Cohesion: 0.12
Nodes (17): appendLocalResponse(), appendStreamingMessage(), buildFormattedMessage(), createMissingAgentResponse(), toChatHistory(), normalizePrompt(), sendAgentMessage(), createStreamCallbacks() (+9 more)
...
Cohesion: 0.13
Nodes (28): get_file_diff(), get_file_diff_at_commit(), get_file_history(), test_get_file_diff(), test_get_file_diff_at_commit(), test_get_file_diff_at_initial_commit(), test_get_file_history_no_commits(), test_get_file_history_with_commits() (+20 more)
...
Cohesion: 0.15
Nodes (10): generateVector(), runHNSWIndexingBenchmarks(), BenchmarkRunner, createBenchmarkSuite(), formatTime(), meetsTarget(), measureColdStart(), runColdStartBenchmarks() (+2 more)
...
Cohesion: 0.12
Nodes (3): ConnectionPool, createConnectionPool(), ManagedConnection
...
Cohesion: 0.1
Nodes (11): isSelectionActive(), droppedNoteWikilinkTarget(), NoteDropHarness(), useNoteWikilinkDrop(), DraggableNoteItem(), clearDraggedNotePath(), readDraggedNotePath(), writeDraggedNotePath() (+3 more)
...
Cohesion: 0.14
Nodes (26): test_create_vault_folder_rejects_escape_path(), test_create_vault_folder_rejects_windows_invalid_names(), with_requested_root(), commands_reject_paths_outside_requested_vault(), copy_image_to_vault(), create_note_content(), create_vault_folder(), ensure_missing_folder() (+18 more)
...
Cohesion: 0.21
Nodes (8): cancelTask(), formatDuration(), getActiveSwarmId(), getPriorityBadge(), getTaskStatusBadge(), listTasks(), retryTask(), watchTaskProgress()
...
Cohesion: 0.11
Nodes (4): FlamingoAttention, AttentionFactory, AttentionSQLBuilder, createDefaultRegistry()
...
Cohesion: 0.12
Nodes (13): AiPanelView(), EditorRightPanel(), useAiPanelContextSnapshot(), useAiPanelController(), useAiPanelFocus(), useAiPanelPromptQueue(), useQueuedAiPrompt(), useCliAiAgent() (+5 more)
...
Cohesion: 0.13
Nodes (6): populateTestData(), ConsciousnessTestRunner, array(), chunk(), range(), flush_list()
...
Cohesion: 0.2
Nodes (3): GtBridge, GtBridgeError, hashArgs()
...
Cohesion: 0.2
Nodes (16): persistModeOverride(), usePropertyPanelState(), detectPropertyType(), detectStringType(), formatDateValue(), isDateKey(), isDateString(), isIconKey() (+8 more)

### Community 749 - "Community 749"
Cohesion: 0.16
Nodes (15): parseDateValue(), ColorEditableValue(), ColorSwatch(), dateToISO(), handleSelect(), normalizePropertyKey(), parseDateValue(), showsRelationshipPropertyIcon() (+7 more)
...
Cohesion: 0.19
Nodes (15): resolveNoteWindowEntry(), findNoteWindowEntry(), getCurrentWindowLabel(), getNoteWindowLabel(), getNoteWindowParams(), getNoteWindowPathCandidates(), getStoredNoteWindowParams(), isNoteWindow() (+7 more)
...
Cohesion: 0.18
Nodes (5): createSemanticRouter(), compareVersions(), createTeammateBridge(), TeammateError, cleanupTestDir()
...
Cohesion: 0.11
Nodes (9): Main execution method for Foundation Agent                  Args:             da, Automatically detect if task is classification or regression, Advanced feature selection, Create final end-to-end pipeline, Save all outputs to disk, Coordinate handoff to next agent, Store insights in memory, Handle errors and notify coordination system (+1 more)
...
Cohesion: 0.16
Nodes (4): ProofChain, createMockEvent(), createMockMemoryOp(), createMockToolCall()
...
Cohesion: 0.15
Nodes (10): ConnectionPool, OptimizedExecutor, Connection pool for resource management., Release a connection back to the pool., Get current pool size., Get number of active connections., High-performance executor with connection pooling and parallel optimization., Execute tasks in parallel with optimized resource management. (+2 more)
...
Cohesion: 0.24
Nodes (6): createVerificationCommand(), executeVerificationFromCLI(), initializeVerificationCLI(), integrateWithClaudeFlowCLI(), VerificationCLICommands, testVerificationSystem()
...
Cohesion: 0.16
Nodes (9): Generate meta-features from base model predictions, Make predictions using meta-model, Probability predictions for classification, Make predictions using gated mixture of experts, Make Bayesian averaged predictions, Make weighted predictions, Advanced stacking ensemble with meta-learner, Fit base models and meta-model (+1 more)
...
Cohesion: 0.38
Nodes (5): createBrowserService(), createBrowserSwarm(), containsPII(), getSecurityScanner(), isUrlSafe()
...
Cohesion: 0.15
Nodes (12): mock_batch_config(), mock_memory_snapshot(), mock_mle_star_config(), Provide categorized test prompts., Provide temporary output directory for test results., Provide mock MLE-STAR configuration., Provide mock batch configuration., Provide mock memory snapshot. (+4 more)

### Community 1076 - "Community 1076"
Cohesion: 0.15
Nodes (12): mock_claude_config_content(), mock_ensemble_results(), mock_execution_log(), mock_performance_targets(), mock_project_context(), performance_baseline(), Provide performance baseline metrics., Provide mock ensemble results. (+4 more)
...
Cohesion: 0.26
Nodes (7): extractDartName(), extractDartParameters(), extractDartReturnType(), extractDartVisibility(), extractParamsFromList(), extractSingleParam(), getInnerSignature()
...
Cohesion: 0.21
Nodes (7): EnhancedFoundationAgent, Select best baseline model without hyperparameter tuning, Generate comprehensive results report, Get summary of preprocessing steps, Extract feature importance if available, Generate actionable recommendations, Enhanced MLE-STAR Foundation Agent          Advanced features:     - Multi-datas
...
Cohesion: 0.21
Nodes (8): DataConfig, DataValidator, fit(), Data pipeline infrastructure for MLE-STAR framework., Configuration for data pipeline., Validates data quality and consistency., Initialize data validator., Generate a human-readable validation report.
...
Cohesion: 0.44
Nodes (10): benchmark(), calculateMean(), calculateMedian(), calculatePercentile(), calculateStdDev(), compareResults(), forceGC(), getMemoryUsage() (+2 more)
...
Cohesion: 0.18
Nodes (6): Standard scaling transformation., Initialize standard scaler., Apply scaling transformation., Initialize min-max scaler., Initialize data pipeline., StandardScaler
...
Cohesion: 0.25
Nodes (11): assertRequestHandlerCapability(), constructor(), createDefaultAjvInstance(), getLiteralValue(), getMethodLiteral(), getObjectShape(), isZ4Schema(), parseWithCompat() (+3 more)
...
Cohesion: 0.24
Nodes (5): Validate data quality.                  Args:             X: Input features, Fit the pipeline to training data., Transform data using fitted pipeline., Fit pipeline and transform data., Fit and transform in one step.
...
Cohesion: 0.22
Nodes (5): EnsembleOptimizer, MLE-STAR Ensemble Agent Implementation Sophisticated model ensemble strategies f, Main ensemble optimization class, Create an ensemble with specified strategy, Optimize which models to include in ensemble
...
Cohesion: 0.31
Nodes (4): getDeviceTrustLabel(), createCliCommands(), parseVector(), requireCoordinator()
...
Cohesion: 0.28
Nodes (5): Parser for streaming JSON output from Claude Flow., Parse a single line of streaming JSON output., Parse a structured message., Parse plain text line for patterns., StreamingOutputParser
...
Cohesion: 0.39
Nodes (8): contractKey(), contractRichness(), crossLinkKey(), dedupeContracts(), dedupeCrossLinks(), endpointKey(), mergeContracts(), mergeEndpoints()

### Community 1318 - "Community 1318"
Cohesion: 0.36
Nodes (4): createIgnoreFilter(), isHardcodedIgnoredDirectory(), loadIgnoreRules(), shouldIgnorePath()

### Community 1319 - "Community 1319"
Cohesion: 0.31
Nodes (5): extractPhpDocReturnType(), extractPhpParameters(), extractPhpReturnType(), normalizePhpReturnType(), stripDollar()
...
Cohesion: 0.31
Nodes (3): getAskOrchestration(), createSparcPrompt(), getModeOrchestration()
...
Cohesion: 0.38
Nodes (5): extractGoName(), extractGoOwnerName(), extractGoParameters(), extractGoReceiverType(), extractGoVisibility()
...
Cohesion: 0.38
Nodes (3): Harness(), Harness(), useFilenameAutolinkGuard()
...
Cohesion: 0.7
Nodes (3): expoFileToRouteURL(), stripIndex(), stripRouteGroups()
...
Cohesion: 0.4
Nodes (3): MinMaxScaler, Min-max scaling transformation., Apply min-max scaling transformation.
...
Cohesion: 0.6
Nodes (3): readPidFile(), removePidFile(), writePidFile()
...
- **1397 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `string` connect `Community 68` to `Community 1`, `Community 2`, `Community 3`, `Community 5`, `Community 9`, `Community 1034`, `Community 12`, `Community 524`, `Community 1039`, `Community 16`, `Community 19`, `Community 534`, `Community 23`, `Community 535`, `Community 1049`, `Community 26`, `Community 27`, `Community 30`, `Community 31`, `Community 32`, `Community 33`, `Community 1063`, `Community 40`, `Community 41`, `Community 554`, `Community 555`, `Community 44`, `Community 46`, `Community 47`, `Community 559`, `Community 558`, `Community 51`, `Community 565`, `Community 566`, `Community 567`, `Community 571`, `Community 60`, `Community 61`, `Community 1601`, `Community 66`, `Community 67`, `Community 577`, `Community 578`, `Community 69`, `Community 1607`, `Community 1608`, `Community 1609`, `Community 1098`, `Community 75`, `Community 581`, `Community 582`, `Community 584`, `Community 591`, `Community 80`, `Community 1610`, `Community 82`, `Community 83`, `Community 84`, `Community 91`, `Community 94`, `Community 607`, `Community 96`, `Community 611`, `Community 612`, `Community 613`, `Community 103`, `Community 104`, `Community 105`, `Community 618`, `Community 108`, `Community 109`, `Community 622`, `Community 623`, `Community 112`, `Community 114`, `Community 626`, `Community 117`, `Community 118`, `Community 120`, `Community 121`, `Community 1147`, `Community 124`, `Community 125`, `Community 123`, `Community 640`, `Community 128`, `Community 1154`, `Community 1155`, `Community 645`, `Community 133`, `Community 650`, `Community 140`, `Community 652`, `Community 653`, `Community 143`, `Community 144`, `Community 659`, `Community 149`, `Community 151`, `Community 152`, `Community 669`, `Community 1181`, `Community 671`, `Community 161`, `Community 675`, `Community 676`, `Community 165`, `Community 677`, `Community 169`, `Community 684`, `Community 174`, `Community 687`, `Community 176`, `Community 175`, `Community 1202`, `Community 180`, `Community 182`, `Community 183`, `Community 184`, `Community 185`, `Community 187`, `Community 1211`, `Community 1216`, `Community 705`, `Community 706`, `Community 707`, `Community 708`, `Community 197`, `Community 200`, `Community 712`, `Community 714`, `Community 1227`, `Community 202`, `Community 719`, `Community 725`, `Community 213`, `Community 1752`, `Community 216`, `Community 1242`, `Community 219`, `Community 226`, `Community 740`, `Community 229`, `Community 742`, `Community 741`, `Community 746`, `Community 748`, `Community 749`, `Community 242`, `Community 248`, `Community 250`, `Community 763`, `Community 251`, `Community 258`, `Community 770`, `Community 260`, `Community 259`, `Community 775`, `Community 263`, `Community 267`, `Community 783`, `Community 273`, `Community 274`, `Community 275`, `Community 791`, `Community 1306`, `Community 1308`, `Community 1309`, `Community 291`, `Community 1316`, `Community 810`, `Community 303`, `Community 816`, `Community 305`, `Community 1330`, `Community 819`, `Community 304`, `Community 311`, `Community 312`, `Community 824`, `Community 314`, `Community 317`, `Community 324`, `Community 325`, `Community 326`, `Community 329`, `Community 845`, `Community 1360`, `Community 337`, `Community 851`, `Community 1367`, `Community 1368`, `Community 1369`, `Community 346`, `Community 348`, `Community 863`, `Community 354`, `Community 357`, `Community 871`, `Community 1386`, `Community 369`, `Community 884`, `Community 885`, `Community 377`, `Community 892`, `Community 384`, `Community 897`, `Community 898`, `Community 386`, `Community 900`, `Community 388`, `Community 401`, `Community 1427`, `Community 406`, `Community 1431`, `Community 1432`, `Community 1433`, `Community 410`, `Community 411`, `Community 412`, `Community 413`, `Community 927`, `Community 423`, `Community 425`, `Community 427`, `Community 948`, `Community 949`, `Community 950`, `Community 436`, `Community 442`, `Community 443`, `Community 449`, `Community 450`, `Community 451`, `Community 453`, `Community 454`, `Community 971`, `Community 465`, `Community 978`, `Community 466`, `Community 475`, `Community 1505`, `Community 1506`, `Community 1507`, `Community 995`, `Community 1000`, `Community 489`, `Community 1002`, `Community 1001`, `Community 495`, `Community 1525`, `Community 505`, `Community 507`, `Community 509`?**
  _High betweenness centrality (0.510) - this node is a cross-community bridge._
- **Why does `swarmCommand()` connect `Community 401` to `Community 68`, `Community 78`?**
  _High betweenness centrality (0.080) - this node is a cross-community bridge._
- **Why does `max()` connect `Community 111` to `Community 1`, `Community 130`, `Community 131`, `Community 6`, `Community 7`, `Community 142`, `Community 399`, `Community 145`, `Community 17`, `Community 147`, `Community 660`, `Community 21`, `Community 22`, `Community 146`, `Community 18`, `Community 153`, `Community 25`, `Community 24`, `Community 156`, `Community 668`, `Community 1151`, `Community 416`, `Community 417`, `Community 34`, `Community 35`, `Community 37`, `Community 39`, `Community 42`, `Community 43`, `Community 1581`, `Community 48`, `Community 49`, `Community 308`, `Community 53`, `Community 439`, `Community 1081`, `Community 1082`, `Community 699`, `Community 316`, `Community 700`, `Community 321`, `Community 458`, `Community 843`, `Community 76`, `Community 77`, `Community 462`, `Community 79`, `Community 88`, `Community 1264`, `Community 602`, `Community 603`, `Community 729`, `Community 477`, `Community 97`, `Community 1122`, `Community 99`, `Community 98`, `Community 362`, `Community 875`, `Community 1263`, `Community 1904`, `Community 497`, `Community 498`, `Community 755`, `Community 499`, `Community 629`, `Community 1141`, `Community 631`, `Community 756`, `Community 633`, `Community 1142`, `Community 380`, `Community 639`?**
