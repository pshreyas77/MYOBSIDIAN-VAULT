# Graph Report - ObsidianVault  (2026-07-18)

## Corpus Check
- 9236 files · ~16,726,853 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 50137 nodes · 97449 edges · 3910 communities (2514 shown, 1396 thin omitted)
...
- `load_and_index()` --calls--> `Document`  [INFERRED]
  02 - AREAS/02 AI & Technology/Obsidian RAG System/rag.py → GitNexus/gitnexus/test/fixtures/lang-resolution/python-same-file-method-collision/models.py

## Communities (3910 total, 1396 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (113): createAnalystAgent(), createArchitectAgent(), addCollaborator(), addError(), assignTask(), collectMetrics(), constructor(), createDefaultMetrics() (+105 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (228): BaseStrategy, BenchmarkEngine, BenchmarkEngine, Main benchmark engine for orchestrating swarm tests., Execute a batch of tasks., Main engine for running swarm benchmarks., Initialize the benchmark engine., Submit a task to the benchmark queue. (+220 more)
...
Cohesion: 0.01
Nodes (137): EvaluationResult, Results from model evaluation., DifficultyLevel, SWE-bench dataset loader and management., SWE-bench task categories., Task difficulty levels., Represents a SWE-bench task., Load tasks based on filters.                  Args:             categories: List (+129 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (97): formatHealthStatus(), formatLogLevel(), formatStatus(), getAgentCapabilities(), updateSwarmActivityMetrics(), getClaimsConfigPaths(), loadClaimsConfig(), saveClaimsConfig() (+89 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (114): handleMessage(), ensureAgentDir(), getAgentDir(), getAgentPath(), loadAgentStore(), saveAgentStore(), sanitizeError(), validatePositiveInt() (+106 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (145): extractDartVarType(), extractSwiftVarType(), detectCppConstructorType(), extractCppElementTypeFromTypeNode(), extractCppTemplateTypeArgs(), extractDeclaration(), extractFirstTemplateTypeArg(), extractForLoopBinding() (+137 more)
...
Cohesion: 0.04
Nodes (54): createCallExtractor(), createClassExtractor(), extractScopeSegmentsFromNode(), normalizeQualifiedName(), splitQualifiedName(), createFieldExtractor(), createHeritageExtractor(), createImportResolver() (+46 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (22): classifyDiffLine(), DiffLine(), DiffView(), useIsMobile(), cn(), Calendar(), useCarousel(), useChart() (+14 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (20): getAnalyticsManager(), getAuditManager(), getCloudManager(), getDeploymentManager(), getProjectManager(), getSecurityManager(), ConfigManager, deepClone() (+12 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (79): Calculate quality score based on output analysis., Estimate resource utilization patterns., Aggregate points into histogram buckets., Calculate rate (events per second) over time window., Calculate baseline metrics for comparison., Calculate percentile value., Calculate overall system health score (0-100)., Process convergent thinking pattern - finding single best solution. (+71 more)
...
Cohesion: 0.03
Nodes (99): ABC, AggressiveStrategy, ConfidenceLevel, DecisionContext, DecisionCriteria, DecisionOption, DecisionResult, DecisionStrategy (+91 more)
...
Cohesion: 0.04
Nodes (62): createKnowledgeGraph(), buildTestGraph(), createMinimalTestGraph(), createASTCache(), BindingAccumulator, enrichExportedTypeMap(), buildExportedTypeMapFromGraph(), buildImportedRawReturnTypes() (+54 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (96): cwd(), exit(), callRuvSwarmDirectNeural(), callRuvSwarmMCP(), checkRuvSwarmAvailable(), chunk(), clearLine(), ensureDirectory() (+88 more)
...
Cohesion: 0.04
Nodes (76): expandCopies(), extractDisp(), extractDsn(), extractParam(), extractPgm(), extractProc(), parseJcl(), integrateJclResults() (+68 more)
...
Cohesion: 0.03
Nodes (79): BenchmarkConfig, BenchmarkResult, HiveMindBenchmarkRunner, main(), Execute a hive-mind CLI command and measure performance, Measure current system performance metrics, Run a single benchmark configuration, Configuration for Hive Mind benchmarks (+71 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (105): buildReceiverTypeIndex(), countCallableCandidates(), dedupSwiftExtensionCandidates(), defaultDispatchDecision(), disambiguateByOverloadOrArgTypes(), extractFuncNameFromSourceId(), filterCallableCandidates(), findEnclosingFunction() (+97 more)
...
Cohesion: 0.04
Nodes (23): createCompiler(), GuidanceCompiler, createGates(), createComplianceSuite(), createHeadlessRunner(), createGuidanceHooks(), gateResultsToHookResult(), GuidanceHookProvider (+15 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (48): applyPreset(), handleReset(), handleSave(), CommunicationLog(), DependencyGraph(), PlanVisualization(), QualityGates(), RealTimeEventLog() (+40 more)
...
Cohesion: 0.03
Nodes (14): AgentManager, main(), SwarmLoadTester, createTaskCancelCommand(), createTaskCreateCommand(), createTaskListCommand(), createTaskStatusCommand(), createTaskWorkflowCommand() (+6 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (16): PolicyEngine, TrustEvaluator, FederationEnvelope, FederationNode, FederationSession, getTrustLevelLabel(), isOperationAllowed(), HandshakeService (+8 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (7): MCPClient, MockTransport, ConnectionHealthMonitor, ConnectionStateManager, FallbackCoordinator, ReconnectionManager, RecoveryManager

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (16): ConnectionPool, createConnectionPool(), ManagedConnection, quickStart(), createMCPServer(), createLogger(), createToolContext(), main() (+8 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (73): classification_metrics(), clustering_metrics(), CrossValidator, EvalConfig, MetricsCalculator, ModelComparator, ModelEvaluator, Model evaluation framework for MLE-STAR. (+65 more)

### Community 33 - "Community 33"
Cohesion: 0.05
Nodes (58): cleanCommand(), indexCommand(), listCommand(), removeCommand(), statusCommand(), hasGhCLI(), maybePublishGist(), prompt() (+50 more)

### Community 34 - "Community 34"
Cohesion: 0.04
Nodes (62): resolveDisplayInfo(), InlineWikilinkChipView(), getTypeIcon(), QuickOpenPalette(), SearchPanel(), isSelectionActive(), resolveSectionColors(), toResult() (+54 more)

### Community 35 - "Community 35"
Cohesion: 0.04
Nodes (79): consensus_swarm(), hive_benchmark(), knowledge_swarm(), MockHiveMindBenchmark, MockSwarm, MockSwarmAgent, Unit tests for collective intelligence benchmarking.  Tests the hive mind benchm, Test specific consensus algorithm implementations. (+71 more)
...
Cohesion: 0.05
Nodes (61): ns(), extractDictionaryArgs(), unwrapCsharpCollectionAccessor(), mapReferenceKindToEdgeType(), tryEmitEdge(), resolveCallerGraphId(), resolveDefGraphId(), simpleQualifiedName() (+53 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (29): createConnectionPool(), createPromptRegistry(), definePrompt(), interpolate(), resourceMessage(), textMessage(), createRateLimiter(), rateLimitMiddleware() (+21 more)

### Community 39 - "Community 39"
Cohesion: 0.03
Nodes (57): AsyncPerformanceCollector, CollectionInterval, PerformanceCollector, ProcessMetrics, Collect metrics for tracked processes., Collect system-wide metrics., Aggregate collected metrics into final performance metrics., Metrics for a single process. (+49 more)

### Community 40 - "Community 40"
Cohesion: 0.04
Nodes (72): batch_config(), batch_processor(), MockBatchConfig, MockBatchProcessor, MockBenchmarkTask, MockPipeline, MockPipelineManager, MockPipelineStage (+64 more)
...
Cohesion: 0.04
Nodes (43): readSafe(), buildProtoContext(), buildProtoMap(), contractId(), extractServiceBlocks(), GrpcExtractor, makeContract(), normalizeProtoPath() (+35 more)
...
Cohesion: 0.06
Nodes (58): bridgeExists(), closeBridgeDb(), contractNodeId(), createContractLookupIndex(), ensureBridgeSchema(), errMessage(), fileKey(), findContractNode() (+50 more)

### Community 46 - "Community 46"
Cohesion: 0.03
Nodes (56): CLAUDE.md Optimizer Module  This module provides intelligent optimization of CLA, BenchmarkMetrics, ClaudeMdOptimizer, PerformanceTargets, ProjectContext, CLAUDE.md Configuration Optimizer  Generates optimized CLAUDE.md configurations, Benchmark the effectiveness of a CLAUDE.md configuration.                  Args:, Generate optimization suggestions based on current performance. (+48 more)
...
Cohesion: 0.03
Nodes (14): CrossModalAttention, GraphAttention, HyperbolicAttention, KNNAttention, MixtureOfExpertsAttention, PerceiverAttention, RecurrentAttention, RetrievalAttention (+6 more)
...
Cohesion: 0.03
Nodes (54): AggregatedMetric, MetricAggregator, MetricAnalyzer, MetricCollector, MetricDefinition, MetricPoint, MetricType, Metric Aggregator  Real-time metric collection and aggregation system for Claude (+46 more)
...
Cohesion: 0.04
Nodes (62): MLEStarConfig, MLEStarEnsembleExecutor, MLE-STAR Ensemble Executor  Coordinates multiple ML models in an ensemble, imple, Initialize all models in parallel using swarm agents., Spawn a specialized ML agent for a model., Configuration for MLE-STAR ensemble., Gather predictions from all models in parallel., Build consensus from multiple model predictions.                  Returns: (+54 more)
...
Cohesion: 0.03
Nodes (55): Metrics collection package for swarm benchmarking., MetricsAggregator, Aggregates metrics from multiple sources for comprehensive analysis., Create a named resource monitor., Get the process tracker instance., Aggregate metrics from all sources., Aggregate performance collector metrics., Aggregate resource monitor metrics. (+47 more)

### Community 59 - "Community 59"
Cohesion: 0.05
Nodes (11): createHttpTransport(), HttpTransport, createInProcessTransport(), createTransport(), createTransportManager(), InProcessTransport, TransportManager, createStdioTransport() (+3 more)

### Community 60 - "Community 60"
Cohesion: 0.05
Nodes (32): handleLoadConfig(), handleSaveConfig(), handleValidateConfig(), validateConfigPath(), getAllTools(), getToolByName(), getToolsByCategory(), getToolsByTag() (+24 more)

### Community 61 - "Community 61"
Cohesion: 0.03
Nodes (69): Extract metrics from command output., fold_turns(), init(), Return list of segments: [{'type':'text','content':...}, {'type':'fold','title':, render_sidebar(), _reset_and_rerun(), _function(), int() (+61 more)
...
Cohesion: 0.05
Nodes (35): SystemIntegration, HealthCheckManager, captureTerminalOutput(), createCapturedTerminal(), disposeTerminalBridge(), executeTerminalCommand(), getTerminalById(), initializeTerminalBridge() (+27 more)
...
Cohesion: 0.04
Nodes (23): BdBridgeError, createBdBridge(), hashArgs(), createGtBridge(), GtBridgeError, createSyncBridge(), hashKey(), SyncBridgeError (+15 more)
...
Cohesion: 0.03
Nodes (39): RenameDetectedBanner(), Toast(), MockWebSocket, useAiActivity(), useAiAgentsOnboarding(), isCheckpointEligible(), shouldTriggerCheckpoint(), thresholdMsForTrigger() (+31 more)

### Community 68 - "Community 68"
Cohesion: 0.04
Nodes (49): BenchmarkResult, Result of ensemble benchmark execution., BayesianAveraging, MajorityVoting, Voting Strategies for MLE-STAR Ensemble  Implements various voting and consensus, Simple majority voting strategy.          For classification: returns the most c, Apply majority voting to predictions., Apply majority voting for regression (returns median). (+41 more)

### Community 70 - "Community 70"
Cohesion: 0.05
Nodes (24): getDefaultCollectionManager(), setDefaultCollectionManager(), validatePlugin(), validatePluginMetadata(), getAllOfficialPlugins(), getOfficialCollection(), DefaultServiceContainer, getDefaultRegistry() (+16 more)
...
Cohesion: 0.06
Nodes (57): checkEncryptionAtRest(), decodeKey(), decryptBuffer(), encryptBuffer(), getKey(), isEncryptedBlob(), isEncryptionEnabled(), ensureSessionDir() (+49 more)
...
Cohesion: 0.03
Nodes (53): Run a comprehensive demonstration of all features., run_comprehensive_demo(), Run a benchmark and display the improved report., run_benchmark_with_report(), main(), Run focused hive-mind benchmarks., Run focused SPARC benchmarks., Run comprehensive real benchmark suite. (+45 more)

### Community 77 - "Community 77"
Cohesion: 0.04
Nodes (50): multi_mode(), official(), optimize(), SWE-Bench CLI command integration., Run OFFICIAL SWE-bench evaluation with real dataset.          This command uses, Run SWE-Bench software engineering benchmarks., Test ALL claude-flow non-interactive modes on SWE-bench.          This command b, Run automated optimization to achieve target metrics. (+42 more)

### Community 78 - "Community 78"
Cohesion: 0.04
Nodes (53): auto_make_url(), BaseSession, ClaudeSession, compress_history_tags(), _fix_messages(), __getattr__(), _load_mykeys(), MixinSession (+45 more)

### Community 79 - "Community 79"
Cohesion: 0.04
Nodes (40): extractCppMethodName(), extractCppParameters(), extractCppReturnType(), extractCVarType(), extractFieldType(), extractParamName(), findFunctionDeclarator(), hasVirtualSpecifier() (+32 more)
...
Cohesion: 0.07
Nodes (58): executeCommand(), getCommand(), hasCommand(), listCommands(), registerCommand(), registerCoreCommands(), showAllCommands(), showCommandHelp() (+50 more)
...
Cohesion: 0.03
Nodes (14): InMemoryDeviceRepository, InMemoryFleetRepository, InMemoryTrustHistoryRepository, SeedClientFactory, createMockCoordinator(), makeCoordinator(), makeCoordinator(), createMockCoordinator() (+6 more)
...
Cohesion: 0.05
Nodes (16): BidirectionalAttention, CausalAttention, ChunkAttention, configure(), constructor(), DilatedAttention, FlashAttention, FlashAttentionV2 (+8 more)

### Community 98 - "Community 98"
Cohesion: 0.04
Nodes (36): OnboardingShell(), formatDateKey(), formatDayLabel(), groupCommitsByDay(), isToday(), isYesterday(), tauriCall(), getLocalizedSortOptionLabel() (+28 more)
...
Cohesion: 0.03
Nodes (20): initializeAgentSystem(), getUser(), User(), User, UserService, GET(), fetchGrants(), GET() (+12 more)
...
Cohesion: 0.05
Nodes (6): IoTCoordinator, createMcpTools(), textResult(), makeDevice(), makeMockCoordinator(), HealthProbeWorker
...
Cohesion: 0.04
Nodes (46): getConnectErrorMessage(), shouldCloseAfterResult(), submitRemoteConnection(), tauriCall(), tauriCall(), tauriCall(), tauriCall(), useClaudeCodeStatus() (+38 more)

### Community 110 - "Community 110"
Cohesion: 0.04
Nodes (46): description(), name(), Analysis strategy for data analysis and insights., description(), name(), Auto strategy that automatically selects the best approach., description(), execute() (+38 more)
...
Cohesion: 0.06
Nodes (23): clamp(), CoherenceScheduler, createCoherenceScheduler(), createEconomicGovernor(), EconomicGovernor, safePercentage(), ConformanceRunner, createConformanceRunner() (+15 more)
...
Cohesion: 0.05
Nodes (16): EventEmitter, ProcessManager, checkDependencies(), checkDiskSpace(), checkMemoryAvailable(), checkNetworkConnectivity(), cleanupOnFailure(), cleanupOnShutdown() (+8 more)
...
Cohesion: 0.05
Nodes (45): applyFrontmatterCallbacks(), buildTabManagementOptions(), flushBeforeFrontmatterMutation(), flushBeforeTitleRename(), createImmediateEntry(), renderActions(), isTitleKey(), isTypeFieldKey() (+37 more)
...
Cohesion: 0.04
Nodes (34): AgentSpawner, ExecutionContext, Context for workflow execution with shared state and resources., Async context manager entry., Async context manager exit with cleanup., Clean up allocated resources., Spawn and manage agents for workflow execution., Spawn agents based on capability requirements.                  Args: (+26 more)

### Community 138 - "Community 138"
Cohesion: 0.06
Nodes (20): CuriosityModule, DecisionTransformer, DQNAlgorithm, createNeuralLearningSystem(), NeuralLearningSystem, createPatternLearner(), PatternLearner, createReasoningBank() (+12 more)
...
Cohesion: 0.07
Nodes (43): embedQuery(), getEmbeddingDims(), initEmbedder(), isEmbedderReady(), embedBatch(), embeddingToArray(), embedText(), getEmbedder() (+35 more)
...
Cohesion: 0.07
Nodes (39): buildAiAgentCommands(), explicitSwitchCommands(), restoreGuidanceCommands(), getPromptCopy(), useAiAgentPreferences(), useAiAgentsStatus(), tauriCall(), useVaultAiGuidanceStatus() (+31 more)
...
Cohesion: 0.06
Nodes (27): buildInlineWikilinkSuggestions(), buildTopSuggestions(), matchSingleCharacterQuery(), toSuggestionItems(), buildNextRawEditorAutocomplete(), RawEditorView(), useLatestRef(), useRawEditorAutocompleteController() (+19 more)

### Community 168 - "Community 168"
Cohesion: 0.07
Nodes (35): fileExists(), findGroupsContainingRegistryName(), findSectionMarkerIndex(), generateAIContextFiles(), generateGitNexusContent(), installSkills(), upsertGitNexusSection(), analyzeCommand() (+27 more)
...
Cohesion: 0.06
Nodes (35): buildSettingsFromDraft(), createSettingsDraft(), resolveAnonymousId(), resolveSettingsDraftThemeMode(), resolveTelemetryConsent(), sanitizePositiveInteger(), SettingsPanel(), invokeNativeIfAvailable() (+27 more)
...
Cohesion: 0.05
Nodes (7): CognitiveBridge, createCognitiveBridge(), cosineSimilarity(), createSonaBridge(), SonaBridge, getMCPTools(), getPluginState()

### Community 181 - "Community 181"
Cohesion: 0.04
Nodes (18): extractDartName(), extractDartParameters(), extractDartReturnType(), extractDartVisibility(), extractParamsFromList(), extractSingleParam(), getInnerSignature(), extractGoName() (+10 more)

### Community 182 - "Community 182"
Cohesion: 0.05
Nodes (28): DecisionEngine, Analyze patterns in successful decisions., Analyze patterns in failed decisions., Update effectiveness metrics for different strategies., Autonomous decision-making engine for workflow execution.          The decision, Initialize decision templates for different types., Make a decision based on type, context, and criteria.                  Args:, Execute a decision and track the results.                  Args:             dec (+20 more)

### Community 183 - "Community 183"
Cohesion: 0.08
Nodes (39): integrated_system(), MockIntegratedSystem, MockPipelineWorkflow, monitored_workflow(), pipeline_workflow(), Integration tests for complete pipeline workflows.  Tests end-to-end scenarios c, Stage 1: CLAUDE.md configuration optimization., Stage 2: MLE-STAR ensemble setup and execution. (+31 more)
...
Cohesion: 0.07
Nodes (27): executePrepared(), streamQuery(), JobManager, buildGraph(), ClientDisconnectedError, createServer(), ensureStreamIsWritable(), getNodeQuery() (+19 more)
...
Cohesion: 0.11
Nodes (18): main(), verify(), createDatabase(), detectPlatform(), getAvailableProviders(), getPlatformInfo(), selectProvider(), testBetterSqlite3() (+10 more)
...
Cohesion: 0.08
Nodes (40): blockSupportsTextCursor(), findNearestTextCursorBlock(), findNearestTextCursorBlockById(), buildBlockLineRanges(), buildBlockNoteRestoreState(), buildCodeMirrorRestoreState(), captureRawCodeMirrorRestoreState(), captureRawEditorPositionSnapshot() (+32 more)
...
Cohesion: 0.09
Nodes (24): addEventListener(), AgenticFlowEmbeddingService, applyNormalization(), autoInstallAgenticFlow(), checkPersistentCache(), clearCache(), computeSimilarity(), constructor() (+16 more)
...
Cohesion: 0.07
Nodes (6): AttentionBridge, createAttentionBridge(), cosineSimilarity(), createNervousSystemBridge(), NervousSystemBridge, shutdownPlugin()
...
Cohesion: 0.12
Nodes (29): calculateAverageLatency(), complete(), constructor(), destroy(), estimateCost(), estimateTokens(), getRateLimitRemaining(), getRateLimitReset() (+21 more)

### Community 213 - "Community 213"
Cohesion: 0.11
Nodes (32): createDiscoveryService(), batchDownload(), createDownloader(), createPatternStore(), checkContributionStatus(), createPublisher(), quickPublish(), submitContribution() (+24 more)
...
Cohesion: 0.06
Nodes (28): OptimizationRule, OptimizationRulesEngine, Optimization Rules Engine  Apply optimization rules to CLAUDE.md configurations, Optimize configuration for maximum accuracy and correctness.                  Ar, Represents a single optimization rule., Optimize configuration for token efficiency.                  Args:, Optimize configuration for memory efficiency.                  Args:, Apply optimization rules to CLAUDE.md configurations.          This engine conta (+20 more)

### Community 216 - "Community 216"
Cohesion: 0.11
Nodes (32): runRedactionCheck(), validateNoSensitiveData(), buildReasoningBankCommand(), checkBasicMode(), clearMemory(), detectMemoryMode(), detectModes(), exportMemory() (+24 more)
...
Cohesion: 0.08
Nodes (35): batch_delete_notes_async(), batch_delete_notes_async_validates_and_deletes_inside_vault(), build_vault_root_paths(), canonicalize_candidate_for_write(), find_existing_ancestor(), load_configured_active_vault_root(), path_to_string(), validate_relative_child_path() (+27 more)
...
Cohesion: 0.14
Nodes (23): createAgentFailedEvent(), createAgentSpawnedEvent(), createAgentStartedEvent(), createAgentStoppedEvent(), createAgentTaskAssignedEvent(), createAgentTaskCompletedEvent(), createDomainEvent(), createMemoryDeletedEvent() (+15 more)

### Community 231 - "Community 231"
Cohesion: 0.09
Nodes (26): createGnnBridge(), createMinCutBridge(), CodeIntelligencePlugin, analyzeAPISurface(), buildSuggestedModules(), calculateCohesionMetrics(), calculateCouplingMetrics(), calculateHealthScore() (+18 more)
...
Cohesion: 0.08
Nodes (35): buildFilterCommands(), buildGitCommands(), localizeCommandActions(), localizeCommandGroup(), localizeSettingsStateCommand(), localizeTypeCommand(), parenthesizedSuffix(), stripKnownPrefix() (+27 more)
...
Cohesion: 0.09
Nodes (25): createDagBridge(), createPlugin(), LegalContractsPlugin, assessRisks(), buildCategorySummary(), buildNegotiationPriorities(), buildTimeline(), calculateOverallRiskScore() (+17 more)
...
Cohesion: 0.09
Nodes (31): augment(), findRepoForCwd(), augmentCommand(), createFTSIndex(), ensureFTSIndex(), loadFTSExtension(), queryFTS(), addPoolCloseListener() (+23 more)

### Community 244 - "Community 244"
Cohesion: 0.09
Nodes (20): ensureAndParse(), findDeclarationNode(), findFunctionNode(), extractFieldNames(), extractMethodNames(), extractStructuralNames(), loadDartOrSkip(), getProvider() (+12 more)
...
Cohesion: 0.11
Nodes (16): attentionControlHandler(), calculateAvgPriority(), cognitiveLoadHandler(), collectiveMemoryHandler(), emergentProtocolHandler(), metaMonitorHandler(), neuralConsensusHandler(), scaffoldHandler() (+8 more)
...
Cohesion: 0.13
Nodes (43): agentCommand(), agenticConfigDelete(), agenticConfigGet(), agenticConfigList(), agenticConfigReset(), agenticConfigSet(), agenticConfigWizard(), agenticMcpList() (+35 more)
...
Cohesion: 0.11
Nodes (29): checkAvailability(), fetchFromIPFS(), fetchFromIPFSWithMetadata(), formatBytes(), getGatewayUrl(), getGatewayUrls(), hashContent(), isPinned() (+21 more)
...
Cohesion: 0.12
Nodes (14): createA2C(), A2CAlgorithm, createCuriosity(), createDecisionTransformer(), createDQN(), createAlgorithm(), getDefaultConfig(), createPPO() (+6 more)

### Community 261 - "Community 261"
Cohesion: 0.06
Nodes (26): isVisibleRect(), isWithinBlockNoteHandleHoverBridge(), shouldSuppressBlockNoteHandleHoverUpdate(), useBlockNoteSideMenuHoverGuard(), applySeededColumnWidths(), findTitleHeadingElement(), handleToolbarMouseDownCapture(), queueTitleHeadingCursorRepair() (+18 more)

### Community 262 - "Community 262"
Cohesion: 0.06
Nodes (20): handleKeyDown(), handleSelectCommand(), handleSubmitAiPrompt(), inputSelectionRange(), insertNativePathDrop(), matchCommand(), rememberCommandOpener(), setSelection() (+12 more)

### Community 263 - "Community 263"
Cohesion: 0.09
Nodes (35): get_vault_ai_guidance_status(), guidance_commands_report_and_restore_vault_guidance_files(), restore_vault_ai_guidance(), clone_git_repo(), clone_repo(), git_add_remote(), GitAddRemoteRequest, create_initialized_vault() (+27 more)

### Community 264 - "Community 264"
Cohesion: 0.06
Nodes (23): ClaudeFlowRealExecutor, Real executor for Claude Flow commands with comprehensive metrics., Initialize real executor.                  Args:             claude_flow_path: P, Execute real swarm with ./claude-flow and measure performance., Execute real hive-mind with ./claude-flow.                  Args:             ta, Execute real SPARC mode with ./claude-flow.                  Args:             m, Extract token usage from Claude Flow output., Extract agent count from Claude Flow output. (+15 more)
...
Cohesion: 0.09
Nodes (22): createConvoyTracker(), BeadsError, CLIExecutionError, ConvoyError, FormulaError, getErrorMessage(), isBeadsError(), isCLIExecutionError() (+14 more)

### Community 270 - "Community 270"
Cohesion: 0.11
Nodes (17): createHyperbolicBridge(), initializePlugin(), validateConfig(), embedHierarchyHandler(), entailmentGraphHandler(), getGnnBridge(), getHyperbolicBridge(), hierarchyCompareHandler() (+9 more)
...
Cohesion: 0.08
Nodes (24): LLMSession, ToolClient, _make_sse_response(), Integration tests for MiniMax provider support.  These tests verify end-to-end M, Verify the actual HTTP request has clamped temperature for MiniMax., Live integration tests against MiniMax API (requires MINIMAX_API_KEY)., Send a real chat completion to MiniMax API., Full ToolClient pipeline with real MiniMax API. (+16 more)
...
Cohesion: 0.06
Nodes (5): ByzantineConsensus, ConsensusEngine, GossipConsensus, ProofOfLearningConsensus, RaftConsensus
...
Cohesion: 0.11
Nodes (11): compareVersions(), createTeammateBridge(), TeammateError, cleanupTestDir(), CircuitBreakerOpenError, RateLimiter, calculateBackoffDelay(), createRetryState() (+3 more)
...
Cohesion: 0.06
Nodes (43): aborted(), add(), assertCanSetRequestHandler(), assertNotificationCapability(), assertRequestHandlerCapability(), constructor(), createDefaultAjvInstance(), _enqueueTaskMessage() (+35 more)
...
Cohesion: 0.15
Nodes (29): formatPriority(), formatUpdateType(), checkForUpdates(), checkSinglePackage(), fetchPackageInfo(), getInstalledVersion(), getUpdateType(), shouldAutoUpdate() (+21 more)
...
Cohesion: 0.08
Nodes (10): SecurityComplianceChecker, createDeepMock(), createMock(), createRetryMock(), createSequenceMock(), createSpyMock(), InteractionRecorder, createSwarmTestInstance() (+2 more)
...
Cohesion: 0.1
Nodes (11): autoAgentCommand(), automationAction(), getMLEStarWorkflowPath(), loadWorkflowFromFile(), WorkflowExecutor, generateId(), mleStarCommand(), runWorkflowCommand() (+3 more)
...
Cohesion: 0.15
Nodes (27): anonymizeCFP(), detectPII(), getSeverity(), hash(), redactPII(), scanCFPForPII(), createSeraphineGenesis(), createSeraphinePatterns() (+19 more)
...
Cohesion: 0.1
Nodes (21): agentErrorEvent(), agentSpawnedEvent(), agentStatusChangedEvent(), agentTaskAssignedEvent(), agentTaskCompletedEvent(), createEvent(), EventBus, InMemoryEventStore (+13 more)

### Community 312 - "Community 312"
Cohesion: 0.08
Nodes (3): DefaultEventBus, DefaultLogger, PluginRegistry
...
Cohesion: 0.08
Nodes (9): BalancedMode, applyLoRATransform(), cleanup(), constructor(), cosineSimilarity(), initialize(), RealTimeMode, getModeConfig() (+1 more)
...
Cohesion: 0.12
Nodes (30): CoordinationMode, ExecutionStrategy, OutputFormat, Claude-Flow Executor - Integration layer for executing claude-flow commands.  Th, Configuration for swarm execution., Configuration for SPARC execution., Swarm execution strategies., Swarm coordination modes. (+22 more)
...
Cohesion: 0.08
Nodes (22): AutomatedTestRunner, AutomationConfig, main(), Handle graceful shutdown on signals, Create test profile from configuration, Generate comprehensive test configurations, Validate test environment and dependencies, Run single benchmark with timeout and retry logic (+14 more)

### Community 324 - "Community 324"
Cohesion: 0.06
Nodes (4): MockAgentManager, MockMemoryManager, MockSwarmCoordinator, MockTaskEngine
...
Cohesion: 0.13
Nodes (14): createByzantineConsensus(), createGossipConsensus(), createConsensusEngine(), selectOptimalAlgorithm(), createRaftConsensus(), createAgentPool(), createMessageBus(), createTopologyManager() (+6 more)
...
Cohesion: 0.07
Nodes (4): ComplianceMonitoringMiddleware, PerformanceMonitoringMiddleware, SecurityLoggingMiddleware, SecurityMiddlewareManager
...
Cohesion: 0.1
Nodes (6): BalancedMode, BatchMode, EdgeMode, BaseModeImplementation, RealTimeMode, ResearchMode
...
Cohesion: 0.12
Nodes (11): MemoryMonitor, analyzeMemoryPerformance(), createOptimizeMemoryCommand(), formatMetric(), generateMemoryReport(), getStatusBadge(), getTrendIndicator(), performMemoryCleanup() (+3 more)

### Community 400 - "Community 400"
Cohesion: 0.08
Nodes (8): AttentionRegistry, CrossAttention, MultiHeadAttention, generateRandomVectors(), main(), measure(), printVectorStats(), SelfAttention
...
Cohesion: 0.12
Nodes (15): deleteFromGCS(), downloadFromGCS(), existsInGCS(), generateContentId(), getGCSConfig(), getGCSStatus(), hasGCSCredentials(), isGCloudAuthenticated() (+7 more)
...
Cohesion: 0.12
Nodes (20): appendLocalResponse(), appendStreamingMessage(), buildFormattedMessage(), createMissingAgentResponse(), toChatHistory(), clearAgentConversation(), normalizePrompt(), sendAgentMessage() (+12 more)
...
Cohesion: 0.12
Nodes (7): AnomalyDetectionService, TelemetryIngestionService, makeReading(), buildNormalBaseline(), makeReading(), createService(), makeReading()
...
Cohesion: 0.15
Nodes (26): addEntryWithMock(), buildCreationCollisionMessage(), buildNewEntry(), buildNoteBody(), buildNoteContent(), createNamedNote(), createNoteImmediate(), createPersistFailureMessage() (+18 more)
...
Cohesion: 0.13
Nodes (22): Command, execPath(), getDirname(), getFilename(), getImportMetaUrl(), isMainModule(), kill(), mkdirAsync() (+14 more)
...
Cohesion: 0.13
Nodes (7): ensureDirectory(), RvfLearningStore, makeEwc(), makeLora(), makePattern(), makeTrajectory(), tmpDir()

### Community 461 - "Community 461"
Cohesion: 0.08
Nodes (3): DependencyGraphEmbedder, HyperbolicBatchProcessor, HyperbolicSQL
...
Cohesion: 0.21
Nodes (23): createAgentRegistry(), createSwarmHub(), getSwarmHub(), createTaskOrchestrator(), agentErrorEvent(), agentSpawnedEvent(), agentStatusChangedEvent(), agentTaskAssignedEvent() (+15 more)
...
Cohesion: 0.12
Nodes (6): compareVersions(), DependencyGraph, parseVersion(), satisfiesVersion(), getDefaultEnhancedRegistry(), setDefaultEnhancedRegistry()
...
Cohesion: 0.11
Nodes (3): EventCoordinator, numberToPriority(), priorityToNumber()
...
Cohesion: 0.09
Nodes (6): getDialogCopy(), handleKeyDown(), handleSubmit(), isCloseShortcut(), isSubmitShortcut(), formatShortcutDisplay()
...
Cohesion: 0.11
Nodes (20): checkpointToastMessage(), commitLocally(), commitModeFromRemoteStatus(), commitToastMessage(), createAutomaticCheckpointCommand(), executeAutomaticCheckpoint(), executeCommitAction(), finalizeCheckpoint() (+12 more)
...
Cohesion: 0.09
Nodes (4): AgentHandleImpl, QECoreBridge, QECoreError, TaskHandleImpl
...
Cohesion: 0.13
Nodes (16): serializeEditorBody(), shouldSyncFrontmatterState(), dateLocale(), formatDate(), detectFrontmatterState(), countWords(), extractBacklinkContext(), extractOutgoingLinks() (+8 more)
...
Cohesion: 0.19
Nodes (19): characterChunk(), astChunk(), buildChunk(), chunkByUnits(), chunkNode(), collectDeclarationUnits(), declarationChunk(), findOverlapStartIndex() (+11 more)
...
Cohesion: 0.12
Nodes (3): CircuitBreaker, LoadBalancer, RateLimiter
...
Cohesion: 0.11
Nodes (13): AnalyzeOnboarding(), handleAutoConnect(), AppStateProvider(), useBackend(), BackendError, connectHeartbeat(), connectToServer(), fetchRepos() (+5 more)

### Community 621 - "Community 621"
Cohesion: 0.17
Nodes (16): useGraphState(), handleKeyDown(), handleSelect(), clearSettings(), fetchOpenRouterModels(), getActiveProviderConfig(), getAvailableModels(), getProviderDisplayName() (+8 more)
...
Cohesion: 0.15
Nodes (3): DeterministicToolGateway, makeBudget(), makeSchema()
...
Cohesion: 0.26
Nodes (21): assertOk(), cancelEmbeddings(), deleteRepo(), fetchClusterDetail(), fetchClusters(), fetchGraph(), fetchProcessDetail(), fetchProcesses() (+13 more)
...
Cohesion: 0.18
Nodes (3): createTopologyOptimizer(), loadBMSSP(), TopologyOptimizer

### Community 709 - "Community 709"
Cohesion: 0.2
Nodes (17): persistModeOverride(), detectPropertyType(), detectStringType(), formatDateValue(), getEffectiveDisplayMode(), isColorString(), isDateKey(), isDateString() (+9 more)
...
Cohesion: 0.21
Nodes (9): createPrimeRadiantPlugin(), safeValidate(), validateCausalInput(), validateCoherenceInput(), validateConfig(), validateConsensusInput(), validateMemoryGateInput(), validateSpectralInput() (+1 more)
...
Cohesion: 0.13
Nodes (6): format_name(), validate_email(), find_repo(), find_user(), main(), process_entities()
...
Cohesion: 0.11
Nodes (10): Test the feature engineering module, Test polynomial feature creation, Test statistical feature creation, Test ratio feature creation, Test clustering-based feature creation, Test univariate feature selection, Test PCA dimensionality reduction, Test creating all features with configuration (+2 more)
...
Cohesion: 0.22
Nodes (17): checkAgenticFlow(), checkApiKeys(), checkBuildTools(), checkClaudeCode(), checkConfigFile(), checkDaemonStatus(), checkDiskSpace(), checkGit() (+9 more)

### Community 767 - "Community 767"
Cohesion: 0.21
Nodes (3): cosineSimilarity(), generateId(), PersistentSonaCoordinator
...
Cohesion: 0.13
Nodes (11): AnalyzeProgress(), async(), handleKeyDown(), handleSelectNode(), handleAnalyze(), handleCancel(), isValidGithubUrl(), cancelAnalyze() (+3 more)
...
Cohesion: 0.15
Nodes (10): AdaptiveStrategy, Adaptive strategy that learns from decision history., Evaluate options using historical learning., Calculate base utility using standard approach., Update learning patterns from decision history., Generate a key for option pattern matching., Calculate success score for a decision., Get learning-based adjustment for option. (+2 more)
...
Cohesion: 0.13
Nodes (12): DataConfig, fit(), Data pipeline infrastructure for MLE-STAR framework., Set transform parameters., Standard scaling transformation., Apply scaling transformation., Configuration for data pipeline., Abstract base class for data transformations. (+4 more)
...
Cohesion: 0.15
Nodes (19): abort(), _cleanupTaskProgressHandler(), _cleanupTimeout(), clear(), _clearTaskQueue(), close(), finalize(), fromError() (+11 more)
...
Cohesion: 0.17
Nodes (15): get_advanced_metrics(), get_automation(), get_claude_optimizer(), get_collective(), get_mle_star(), get_version_info(), initialize_config(), Swarm Benchmark - Agent swarm benchmarking tool for Claude Flow.  This package p (+7 more)
...
Cohesion: 0.15
Nodes (8): usePropertyPanelState(), applyToModules(), loadFromStorage(), saveToStorage(), storageKey(), useVaultConfig(), initDisplayModeOverrides(), initTagColors()
...
Cohesion: 0.22
Nodes (10): agentMessagesToChatHistory(), detectFileOperation(), extractBashCommand(), formatToolLabel(), parseBashFileCreation(), parseFilePath(), parseNotePath(), toVaultRelative() (+2 more)
...
Cohesion: 0.17
Nodes (3): GgufEngine, basename(), extractAgents()
...
Cohesion: 0.2
Nodes (9): is_legacy_build_version(), is_numeric_version_part(), parse_legacy_build_label(), get_build_number(), parse_build_label(), parse_calendar_build_label(), parse_semver_build_label(), split_numeric_version_parts() (+1 more)
...
Cohesion: 0.14
Nodes (8): Real SPARC benchmark scenarios., Initialize real SPARC benchmark., Run real SPARC modes with ./claude-flow and measure performance., Benchmark SPARC coder mode., Benchmark SPARC TDD mode., Benchmark SPARC architect mode., Benchmark SPARC optimizer mode., RealSparcBenchmark
...
Cohesion: 0.14
Nodes (7): Test the integration module, Test agent initialization, Test loading CSV dataset, Test loading sample dataset when file doesn't exist, Test processing dataset analysis step, Test processing full pipeline, TestFoundationAgentIntegration
...
Cohesion: 0.15
Nodes (12): async_mock(), coordination_modes(), data_pipeline_structure(), mock_consensus_proposal(), mock_memory_snapshot(), Create a data pipeline project structure for testing., Provide mock memory snapshot., Provide mock consensus proposal. (+4 more)

### Community 1070 - "Community 1070"
Cohesion: 0.15
Nodes (12): event_loop(), mock_token_metrics(), pytest_configure(), Provide categorized test prompts., Provide temporary directory for test files., Configure pytest with custom markers and settings., Provide mock token metrics., Create an instance of the default event loop for the test session. (+4 more)
...
Cohesion: 0.28
Nodes (9): clearCache(), constructor(), detectTaskType(), estimateComplexity(), getCacheKey(), getMetrics(), initializeMetrics(), initializeTaskPatterns() (+1 more)
...
Cohesion: 0.38
Nodes (11): createMockWithBehavior(), createMockAgentLifecycle(), createMockApplication(), createMockEventBus(), createMockLogger(), createMockMCPClient(), createMockMemoryService(), createMockSecurityService() (+3 more)
...
Cohesion: 0.17
Nodes (6): AsyncFileManager, Set a key-value pair with TTL., Async file operations manager for I/O optimization., Write JSON data to file asynchronously., Read JSON data from file asynchronously., Write text content to file asynchronously.
...
Cohesion: 0.21
Nodes (7): EnhancedFoundationAgent, Generate comprehensive results report, Get summary of preprocessing steps, Extract feature importance if available, Generate actionable recommendations, Enhanced MLE-STAR Foundation Agent          Advanced features:     - Multi-datas, Handle errors and notify coordination system
...
Cohesion: 0.36
Nodes (5): getAgentType(), getRouter(), getRuvectorVersion(), isRuvectorAvailable(), isWasmBackendAvailable()
...
Cohesion: 0.27
Nodes (3): TelemetryService, makeDeps(), makeReading()
...
Cohesion: 0.25
Nodes (5): Result aggregation and processing., Initialize the result aggregator., Aggregate results into benchmark metrics., Aggregates and processes benchmark results., ResultAggregator
...
Cohesion: 0.46
Nodes (4): envVarNameFor(), isRegistryPrimary(), parseFlag(), primaryLanguages()
...
Cohesion: 0.68
Nodes (6): adaptationExample(), basicLearningExample(), createMockSteps(), main(), patternDiscoveryExample(), performanceMonitoringExample()

### Community 1437 - "Community 1437"
Cohesion: 0.29
Nodes (4): attemptClone(), repoNameFromUrl(), suggestedPathFromUrl(), tauriCall()
...
Cohesion: 0.48
Nodes (4): formatToolLabel(), markReasoningDone(), updateMessage(), updateToolAction()
...
- **1396 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `string` connect `Community 103` to `Community 0`, `Community 2`, `Community 4`, `Community 5`, `Community 519`, `Community 520`, `Community 1034`, `Community 1036`, `Community 13`, `Community 15`, `Community 530`, `Community 19`, `Community 1044`, `Community 22`, `Community 534`, `Community 24`, `Community 25`, `Community 26`, `Community 27`, `Community 28`, `Community 29`, `Community 30`, `Community 31`, `Community 1056`, `Community 34`, `Community 36`, `Community 37`, `Community 551`, `Community 553`, `Community 42`, `Community 43`, `Community 45`, `Community 47`, `Community 560`, `Community 561`, `Community 1587`, `Community 563`, `Community 568`, `Community 569`, `Community 1594`, `Community 1595`, `Community 572`, `Community 573`, `Community 59`, `Community 63`, `Community 575`, `Community 1593`, `Community 578`, `Community 1093`, `Community 69`, `Community 72`, `Community 74`, `Community 80`, `Community 84`, `Community 85`, `Community 86`, `Community 599`, `Community 1110`, `Community 92`, `Community 605`, `Community 606`, `Community 607`, `Community 96`, `Community 98`, `Community 613`, `Community 616`, `Community 105`, `Community 107`, `Community 108`, `Community 109`, `Community 111`, `Community 114`, `Community 1141`, `Community 118`, `Community 119`, `Community 121`, `Community 633`, `Community 124`, `Community 1148`, `Community 1149`, `Community 127`, `Community 638`, `Community 125`, `Community 126`, `Community 130`, `Community 644`, `Community 128`, `Community 134`, `Community 645`, `Community 129`, `Community 651`, `Community 140`, `Community 653`, `Community 145`, `Community 147`, `Community 148`, `Community 1172`, `Community 663`, `Community 152`, `Community 667`, `Community 668`, `Community 669`, `Community 158`, `Community 155`, `Community 156`, `Community 165`, `Community 678`, `Community 168`, `Community 1193`, `Community 171`, `Community 172`, `Community 684`, `Community 176`, `Community 1201`, `Community 178`, `Community 177`, `Community 1206`, `Community 695`, `Community 1208`, `Community 697`, `Community 696`, `Community 185`, `Community 700`, `Community 188`, `Community 190`, `Community 191`, `Community 703`, `Community 1217`, `Community 705`, `Community 707`, `Community 709`, `Community 713`, `Community 202`, `Community 204`, `Community 1742`, `Community 1231`, `Community 212`, `Community 726`, `Community 217`, `Community 219`, `Community 731`, `Community 226`, `Community 229`, `Community 752`, `Community 240`, `Community 243`, `Community 1267`, `Community 759`, `Community 247`, `Community 248`, `Community 249`, `Community 250`, `Community 764`, `Community 256`, `Community 258`, `Community 771`, `Community 774`, `Community 779`, `Community 269`, `Community 1294`, `Community 270`, `Community 1295`, `Community 781`, `Community 1298`, `Community 281`, `Community 1309`, `Community 801`, `Community 294`, `Community 808`, `Community 811`, `Community 301`, `Community 302`, `Community 303`, `Community 817`, `Community 307`, `Community 308`, `Community 310`, `Community 312`, `Community 313`, `Community 316`, `Community 1342`, `Community 836`, `Community 325`, `Community 326`, `Community 327`, `Community 1352`, `Community 1353`, `Community 1354`, `Community 328`, `Community 336`, `Community 851`, `Community 853`, `Community 856`, `Community 345`, `Community 1370`, `Community 348`, `Community 862`, `Community 863`, `Community 353`, `Community 877`, `Community 881`, `Community 882`, `Community 884`, `Community 372`, `Community 379`, `Community 1416`, `Community 1420`, `Community 1421`, `Community 1422`, `Community 401`, `Community 402`, `Community 412`, `Community 1437`, `Community 414`, `Community 416`, `Community 936`, `Community 937`, `Community 424`, `Community 939`, `Community 427`, `Community 431`, `Community 432`, `Community 438`, `Community 440`, `Community 442`, `Community 443`, `Community 959`, `Community 961`, `Community 450`, `Community 455`, `Community 456`, `Community 968`, `Community 970`, `Community 1487`, `Community 464`, `Community 467`, `Community 1493`, `Community 1494`, `Community 1495`, `Community 990`, `Community 483`, `Community 996`, `Community 997`, `Community 998`, `Community 1509`, `Community 490`, `Community 499`, `Community 500`, `Community 502`, `Community 503`, `Community 504`, `Community 507`, `Community 511`?**
  _High betweenness centrality (0.510) - this node is a cross-community bridge._
- **Why does `swarmCommand()` connect `Community 450` to `Community 81`, `Community 103`?**
  _High betweenness centrality (0.080) - this node is a cross-community bridge._
- **Why does `max()` connect `Community 12` to `Community 2`, `Community 3`, `Community 391`, `Community 136`, `Community 654`, `Community 14`, `Community 18`, `Community 146`, `Community 20`, `Community 21`, `Community 150`, `Community 407`, `Community 149`, `Community 23`, `Community 662`, `Community 406`, `Community 796`, `Community 160`, `Community 1184`, `Community 1698`, `Community 1568`, `Community 35`, `Community 39`, `Community 428`, `Community 44`, `Community 46`, `Community 690`, `Community 691`, `Community 1076`, `Community 51`, `Community 50`, `Community 54`, `Community 183`, `Community 1075`, `Community 58`, `Community 315`, `Community 61`, `Community 446`, `Community 319`, `Community 447`, `Community 834`, `Community 68`, `Community 452`, `Community 76`, `Community 77`, `Community 78`, `Community 717`, `Community 978`, `Community 82`, `Community 596`, `Community 469`, `Community 594`, `Community 215`, `Community 93`, `Community 1119`, `Community 1251`, `Community 867`, `Community 227`, `Community 102`, `Community 743`, `Community 744`, `Community 361`, `Community 1896`, `Community 1252`, `Community 492`, `Community 493`, `Community 622`, `Community 494`, `Community 1136`, `Community 625`, `Community 1137`, `Community 627`, `Community 632`, `Community 1144`, `Community 101`?**
